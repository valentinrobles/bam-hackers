...
var AgentCard_SecuritySchemesEntry = {
  fromJSON(object) {
    return {
      ...
      value: isSet(object.value) ? SecurityScheme.fromJSON(object.value) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var SecurityRequirement_SchemesEntry = {
  fromJSON(object) {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? StringList.fromJSON(object.value) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
function generateAgentCardSignature(privateKey, protectedHeader, header) {
  return async (agentCard) => {
...
function verifyAgentCardSignature(retrievePublicKey) {
  return async (agentCard) => {
...
function canonicalizeAgentCard(agentCard) {
...
export {
  ...
  DeviceCodeOAuthFlow,
  DeviceCodeOAuthFlow_ScopesEntry,
  Extensions,
  ...
  SSE_HEADERS,
  SecurityRequirement,
  SecurityRequirement_SchemesEntry,
  SecurityScheme,
