...
var InMemoryPushNotificationStore = class {
  ...
  async save(taskId, context, pushNotificationConfig) {
    ...
    if (!pushNotificationConfig.id) {
      pushNotificationConfig.id = (0, import_uuid.v4)();
    }
...
var DefaultRequestHandler = class {
  ...
  async _createRequestContext(request, context) {
    ...
    const taskId = incomingMessage.taskId || (0, import_uuid2.v4)();
    ...
    const contextId = incomingMessage.contextId || task?.contextId || (0, import_uuid2.v4)();
