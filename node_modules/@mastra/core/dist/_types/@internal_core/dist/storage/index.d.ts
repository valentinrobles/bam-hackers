...
//#region src/storage/domains/shared.d.ts
...
//#endregion
//#region src/storage/domains/observability/logs.d.ts
...
declare const listLogsArgsSchema: z.ZodPipe<z.ZodObject<{
  ...
  filters: {
    ...
    level?: "debug" | "error" | "fatal" | "info" | "warn" | ("debug" | "error" | "fatal" | "info" | "warn")[] | undefined;
  } | undefined;
  pagination: {
    page: number;
    perPage: number;
...
//#endregion
//#region src/storage/domains/observability/scores.d.ts
/**
...
declare const deleteScoresArgsSchema: z.ZodObject<{
  scoreIds: z.ZodArray<z.ZodString>;
  organizationId: z.ZodOptional<z.ZodString>;
  resourceId: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
/** Arguments for deleting scores */
type DeleteScoresArgs = z.infer<typeof deleteScoresArgsSchema>;
/** Schema for deleteScores operation response */
declare const deleteScoresResponseSchema: z.ZodObject<{
  success: z.ZodBoolean;
}, z.core.$strip>;
/** Response from deleting scores */
type DeleteScoresResponse = z.infer<typeof deleteScoresResponseSchema>;
...
//#endregion
//#region src/storage/domains/observability/feedback.d.ts
declare const feedbackReviewStatusSchema: z.ZodEnum<{
  "needs-review": "needs-review";
  reviewed: "reviewed";
}>;
type FeedbackReviewStatus = z.infer<typeof feedbackReviewStatusSchema>;
...
declare const updateFeedbackReviewStatusArgsSchema: z.ZodObject<{
...
type UpdateFeedbackReviewStatusArgs = z.infer<typeof updateFeedbackReviewStatusArgsSchema>;
/** Schema for deleteFeedback operation arguments */
declare const deleteFeedbackArgsSchema: z.ZodObject<{
  feedbackIds: z.ZodArray<z.ZodString>;
  organizationId: z.ZodOptional<z.ZodString>;
  resourceId: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
/** Arguments for deleting feedback */
type DeleteFeedbackArgs = z.infer<typeof deleteFeedbackArgsSchema>;
/** Schema for deleteFeedback operation response */
declare const deleteFeedbackResponseSchema: z.ZodObject<{
  success: z.ZodBoolean;
}, z.core.$strip>;
/** Response from deleting feedback */
type DeleteFeedbackResponse = z.infer<typeof deleteFeedbackResponseSchema>;
...
//#endregion
//#region src/storage/domains/observability/metrics.d.ts
/**
...
//#endregion
//#region src/storage/domains/observability/discovery.d.ts
