...
import type { ObservationalMemoryRecord, StorageListMessagesInput, StorageListMessagesOutput } from '../storage/types.js';
...
export declare class AgentController<TState = {}> {
     ...
     * workspace/sandbox.
     */
    queryThreadMessages({ threadId, resourceId, perPage, page, orderBy, include, filter, }: Omit<StorageListMessagesInput, 'threadId'> & {
        threadId: string;
     ...
     */
    generateThreadTitle({ threadId, resourceId, scope, model, requestContext: callerContext, }: {
        threadId: string;
        resourceId?: string;
        scope?: string;
