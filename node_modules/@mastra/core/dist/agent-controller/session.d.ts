...
import type { AgentSignalActiveBehavior, AgentSignalIdleBehavior, AgentThreadSubscription, MastraBrowser, SendAgentNotificationSignalOptions, SendAgentNotificationSignalResult, SendAgentSignalAccepted, ToolsetsInput } from '../agent/types.js';
...
import type { StorageListMessagesOutput } from '../storage/types.js';
...
export declare const SUSPENDED_RUN_AGENT_KEY: import("../mastra/run-scope").RunScopeKey<Agent<string, import("../agent").ToolsInput, undefined, any, import("../agent").AgentEditorConfig | undefined>>;
/**
...
export declare class SessionThread {
     ...
     */
    ensureSubscription(threadId: string, agent?: Agent<string, import("../agent").ToolsInput, undefined, any, import("../agent").AgentEditorConfig | undefined>): Promise<void>;
...
export declare class Session<TState = unknown> {
    ...
    private waitForAcceptedRunCompletion;
    /**
    ...
    sendSignalToThread(input: AgentSignalInput, target: {
        resourceId: string;
        threadId: string;
    }): {
        id: string;
    ...
    private prepareMessageTarget;
    /**
     * Send a message to this session's current agent and await the run. Streams
     * the response and emits events.
     */
    sendMessage({ content, files, tracingContext, tracingOptions, requestContext: requestContextInput, untilIdle, }: {
        content: string;
        files?: Array<{
            data: string;
            mediaType: string;
     ...
     */
    queueMessage({ content, files, tracingContext, tracingOptions, requestContext: requestContextInput, }: {
        content: string;
        files?: Array<{
            data: string;
            mediaType: string;
     ...
     */
    resumeToolCall({ resumeData, toolCallId, requestContext: requestContextInput, resolveOnToolEnd, }: {
        resumeData: any;
        toolCallId: string;
        requestContext?: RequestContext;
