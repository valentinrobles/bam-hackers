...
export declare function addOptionalUsageField(usage: TokenUsage, key: keyof Pick<TokenUsage, 'reasoningTokens' | 'cachedInputTokens' | 'cacheCreationInputTokens' | 'cacheCreationInputTokens5m' | 'cacheCreationInputTokens1h'>, value: number | undefined): void;
