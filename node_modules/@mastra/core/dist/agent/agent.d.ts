...
import type { AgentClaimThreadPeerOptions, AgentConfig, AgentDurableOption, AgentGenerateOptions, GoalConfig, AgentStreamOptions, ToolsetsInput, ToolsInput, AgentModelManagerConfig, AgentEditorConfig, AgentInstructions, AgentMessageInput, AgentMethodType, AgentSignal, AgentStateSignalInput, AgentSubscribeToThreadOptions, AgentThreadIdentityOptions, AgentThreadPeerAdvertisement, AgentThreadSubscription, DiscoverAgentThreadPeersOptions, CancelQueuedAgentMessagesOptions, CancelQueuedAgentMessagesResult, AgentThreadEventListener, SubscribeAgentThreadEventsOptions, PublicStructuredOutputOptions, QueueAgentMessageOptions, QueueAgentMessageResult, SendAgentMessageOptions, SendAgentMessageResult, SendAgentNotificationSignalOptions, SendAgentNotificationSignalResult, SendAgentSignalOptions, SendAgentSignalResult, SendAgentStateSignalOptions, SendAgentStateSignalResult, SendAgentStreamResumeOptions, SendAgentStreamResumeResult, ModelFallbackSettings, ModelWithRetries, ZodSchema } from './types.js';
...
TRequestContext extends Record<string, any> | unknown = any, TEditor extends AgentEditorConfig | undefined = AgentEditorConfig | undefined> extends MastraBase implements SubAgent<TAgentId, TRequestContext> {
     ...
     * @internal
     */
    __setThreadRuntimeAgent(agent: Agent<any, any, any, any>): void;
    /**
    ...
    __getOverridableFields(): {
        ...
        model: ModelFallbacks | DynamicArgument<ModelWithRetries[] | MastraModelConfig, TRequestContext>;
     ...
     * @experimental Agent signals are experimental and may change in a future release.
     */
    claimThreadOwnership<OUTPUT = TOutput>(options: {
        resourceId: string;
        threadId: string;
     ...
     * @experimental Agent signals are experimental and may change in a future release.
     */
    discoverThreadPeers(options?: DiscoverAgentThreadPeersOptions): Promise<AgentThreadPeerAdvertisement[]>;
