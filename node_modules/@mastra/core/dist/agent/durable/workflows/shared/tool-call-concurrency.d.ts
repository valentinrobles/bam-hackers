import type { DurableToolCallInput, SerializableDurableOptions, SerializableToolMetadata } from '../../types.js';
/**
 ...
 */
export declare function resolveDurableToolCallConcurrency({ options, toolsMetadata, toolCalls, }: {
