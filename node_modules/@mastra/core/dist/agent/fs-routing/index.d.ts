import type { MastraScorer, MastraScorerEntry } from '../../evals/index.js';
...
import type { AgentScheduleDefinition } from '../../schedules/define.js';
...
import type { AgentConfig, AgentInstructions, ToolsInput } from '../types.js';
/**
 ...
 * ```
 */
export declare function agentInstructions<TRequestContext extends Record<string, any> | unknown = unknown>(instructions: DynamicArgument<AgentInstructions, TRequestContext>): DynamicArgument<AgentInstructions, TRequestContext>;
export { defineSchedule } from '../../schedules/define.js';
export type { AgentScheduleDefinition, AgentScheduleHandler, DeclaredAgentSchedule } from '../../schedules/define.js';
/**
