 ...
 */
export declare function createGoalScorer({ judgeModel, prompt, tools, memory, defaultMemoryOptions, onStream, maxSteps, mastra, requestContext, inputProcessors, errorProcessors, }: {
