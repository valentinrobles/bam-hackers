...
export type AgentSignalInput = (AgentSignalInputBase & {
    type: 'state';
    /**
 ...
 * @experimental Agent signals are experimental and may change in a future release.
 */
export type CreatedAgentSignal = (CreatedAgentSignalBase & {
    type: 'state';
    transient?: never;
 ...
 * @experimental Agent signals are experimental and may change in a future release.
 */
export declare function isUserAuthoredMessage(message: MastraDBMessage): boolean;
/**
 ...
 * @experimental Agent signals are experimental and may change in a future release.
 */
export declare function isTransientSignalMessage(message: MastraDBMessage): boolean;
...
export declare function createSignal(input: Extract<AgentSignalInput, {
    type: 'state';
}>): Extract<CreatedAgentSignal, {
    type: 'state';
}>;
export declare function createSignal(input: Extract<AgentSignalInput, {
    type: Exclude<AgentSignalType, 'state'>;
