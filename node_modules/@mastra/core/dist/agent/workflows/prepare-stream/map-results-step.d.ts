...
export declare function createMapResultsStep<OUTPUT = undefined>({ capabilities, options, resourceId, threadId: threadIdFromArgs, runId, requestContext, memory, memoryConfig, agentSpan, agentId, agentVersionId, methodType, saveQueueManager, runScope, }: MapResultsStepOptions<OUTPUT>): Step<string, unknown, {
