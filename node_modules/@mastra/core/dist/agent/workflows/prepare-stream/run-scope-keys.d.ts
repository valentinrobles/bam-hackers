...
import type { MemoryRunState } from '../../../memory/run-state.js';
 ...
 */
export declare const MESSAGE_LIST_KEY: import("../../../mastra/run-scope").RunScopeKey<MessageList>;
export declare const CONVERTED_TOOLS_KEY: import("../../../mastra/run-scope").RunScopeKey<Record<string, any>>;
export declare const PROCESSOR_STATES_KEY: import("../../../mastra/run-scope").RunScopeKey<Map<string, ProcessorState<undefined>>>;
export declare const INITIAL_SIGNAL_ECHOES_KEY: import("../../../mastra/run-scope").RunScopeKey<CreatedAgentSignal[]>;
export declare const MEMORY_RUN_STATE_KEY: import("../../../mastra/run-scope").RunScopeKey<MemoryRunState>;
/**
 ...
 * generic is in scope.
 */
export declare const LOOP_OPTIONS_KEY: import("../../../mastra/run-scope").RunScopeKey<ModelLoopStreamArgs<ToolSet, unknown>>;
