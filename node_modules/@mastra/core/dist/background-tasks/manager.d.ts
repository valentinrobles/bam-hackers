...
export declare class BackgroundTaskManager {
    ...
    private readonly processAffineDispatchTopic;
    config: Required<Pick<BackgroundTaskManagerConfig, 'globalConcurrency' | 'perAgentConcurrency' | 'backpressure' | 'defaultTimeoutMs' | 'recoverStaleTasksOnStart'>> & BackgroundTaskManagerConfig;
    ...
    private reserveLocalSlot;
    private releaseLocalSlot;
