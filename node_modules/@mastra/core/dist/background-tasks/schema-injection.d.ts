 ...
 */
export declare const backgroundOverrideJsonSchema: {
    type: 'object';
    description: string;
    properties: {
        enabled: {
...
export declare const backgroundOverrideZodSchema: z.ZodOptional<z.ZodObject<{
...
//# sourceMappingURL=schema-injection.d.ts.map