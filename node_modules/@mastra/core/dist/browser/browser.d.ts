 ...
 */
export declare const DEFAULT_BROWSER_VIEWPORT: BrowserViewportSize;
/**
 * Narrow a viewport config to explicit dimensions, or `undefined` for `'window'`.
 */
export declare function resolveViewportSize(viewport: BrowserViewport | undefined): BrowserViewportSize | undefined;
/**
 ...
 */
export declare function resolveLaunchViewport(viewport: BrowserViewport | undefined): {
