 ...
 */
export declare function runStreamingDriver({ stream, chatThread, adapter, toolDisplay, toolDisplayFn, streamingOptions, channelToolNames, logger, onApprovalPosted, getPendingApproval, takePendingApproval, typingGate, formatError, textFormat, }: StreamingDriverArgs): Promise<void>;
//# sourceMappingURL=chat-driver-streaming.d.ts.map