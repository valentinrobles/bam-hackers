import type { ActionEvent, Adapter, CardElement, ChatConfig, Message, SlashCommandEvent, StateAdapter, StreamChunk, Thread } from 'chat';
 ...
 */
export type SlashCommandChannelHandler = (event: SlashCommandEvent, defaultHandler: () => Promise<void>, ctx: ChannelHandlerContext) => Promise<void>;
 ...
 */
export type ActionChannelHandler = (event: ActionEvent, defaultHandler: () => Promise<void>, ctx: ChannelHandlerContext) => Promise<void>;
