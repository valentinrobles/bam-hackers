...
const require_tracing = require("./tracing-BacWgQDZ.cjs");
...
*/
const batchDeleteTracesArgsSchema = zod_v4.z.object({
	traceIds: zod_v4.z.array(require_utils.traceIdField).max(BATCH_DELETE_TRACES_MAX_IDS).describe(`Trace IDs to delete (maximum ${BATCH_DELETE_TRACES_MAX_IDS})`),
	organizationId: require_utils.organizationIdField.optional().describe("Optional tenant scope: only delete rows belonging to this organization"),
	resourceId: require_utils.resourceIdField.optional().describe("Optional tenant scope: only delete rows belonging to this resource")
}).describe("Arguments for batch deleting traces");
/** Schema for batchDeleteTraces route response */
const batchDeleteTracesResponseSchema = zod_v4.z.object({ success: zod_v4.z.literal(true) }).describe("Response for batch deleting traces");
...
Object.defineProperty(exports, "BATCH_DELETE_TRACES_MAX_IDS", {
	enumerable: true,
	get: function() {
		return BATCH_DELETE_TRACES_MAX_IDS;
	}
});
...
Object.defineProperty(exports, "batchDeleteTracesResponseSchema", {
	enumerable: true,
	get: function() {
		return batchDeleteTracesResponseSchema;
	}
});
...
//# sourceMappingURL=constants-BV7TjhE-.cjs.map