import { Bn as tagsField, Cn as resourceIdField, F as dateRangeSchema, G as deltaLimitSchema, Hn as traceIdField, I as dbTimestamps, In as sortDirectionSchema, Rn as spanContextFields, U as deltaCursorSchema, W as deltaInfoSchema, Zt as listModeSchema, _n as paginationInfoSchema, gn as paginationArgsSchema, hn as organizationIdField, mn as normalizeObservabilityListArgs, on as metadataField, xn as refineObservabilityListMode, zn as spanIdField } from "./utils-C64E0GKG.js";
import { n as SpanType } from "./tracing-D2hyX6p5.js";
...
function extractTrajectory(output) {
	...
	for (const message of output) {
		...
		const fromParts = message?.content?.parts?.filter((p) => p.type === "tool-invocation").map((p) => p.toolInvocation).filter(Boolean) ?? [];
		...
		for (const invocation of fromParts) {
			const sharedIndex = invocation.toolCallId ? legacyPositions.get(invocation.toolCallId) : void 0;
			if (sharedIndex !== void 0 && sharedIndex >= legacyIndex) {
		...
		for (const invocation of toolInvocations) if (invocation && invocation.toolName && (invocation.state === "result" || invocation.state === "call" || invocation.state === "output-error")) {
...
const BATCH_DELETE_TRACES_MAX_IDS = 1e3;
/**
* Schema for batchDeleteTraces operation arguments
*/
const batchDeleteTracesArgsSchema = z.object({
	traceIds: z.array(traceIdField).max(BATCH_DELETE_TRACES_MAX_IDS).describe(`Trace IDs to delete (maximum ${BATCH_DELETE_TRACES_MAX_IDS})`),
	organizationId: organizationIdField.optional().describe("Optional tenant scope: only delete rows belonging to this organization"),
	resourceId: resourceIdField.optional().describe("Optional tenant scope: only delete rows belonging to this resource")
}).describe("Arguments for batch deleting traces");
/** Schema for batchDeleteTraces route response */
const batchDeleteTracesResponseSchema = z.object({ success: z.literal(true) }).describe("Response for batch deleting traces");
...
//#endregion
export { TABLE_MCP_CLIENT_VERSIONS as $, getSpanResponseSchema as $t, SKILL_BLOBS_SCHEMA as A, matchesExpectedWorkflowStatus as An, WORKSPACE_VERSIONS_SCHEMA as At, TABLE_DATASET_ITEMS as B, scoringHookInputSchema as Bn, branchesFilterSchema as Bt, OLD_SPAN_SCHEMA as C, tracesOrderByFieldSchema as Cn, TABLE_WORKFLOW_SNAPSHOT as Ct, SCORER_DEFINITIONS_SCHEMA as D, STORAGE_FAVORITE_ENTITY_TYPES as Dn, TOOL_PROVIDER_CONNECTIONS_SCHEMA as Dt, SCORERS_SCHEMA as E, updateSpanRecordSchema as En, THREAD_STATE_SCHEMA as Et, TABLE_BACKGROUND_TASKS as F, saveScorePayloadSchema as Fn, TraceStatus as Ft, TABLE_HARNESS_SESSIONS as G, scoringPromptsSchema as Gn, createSpanArgsSchema as Gt, TABLE_EXPERIMENTS as H, scoringInputWithExtractStepResultAndAnalyzeStepResultSchema as Hn, branchesOrderBySchema as Ht, TABLE_CHANNEL_CONFIG as I, scoreResultSchema as In, batchCreateSpansArgsSchema as It, TABLE_KNOWLEDGE_MENTIONS as J, getBranchArgsSchema as Jt, TABLE_KNOWLEDGE_ACTIVITY as K, scoringSourceSchema as Kn, createSpanRecordSchema as Kt, TABLE_CHANNEL_INSTALLATIONS as L, scoreRowDataSchema as Ln, batchDeleteTracesArgsSchema as Lt, SPAN_SCHEMA as M, extractTrajectoryFromTrace as Mn, BRANCH_SPAN_TYPES as Mt, TABLE_AGENTS as N, extractWorkflowTrajectory as Nn, BRANCH_SPAN_TYPE_SET as Nt, SCORER_DEFINITION_VERSIONS_SCHEMA as O, STORAGE_VISIBILITY_VALUES as On, WORKFLOW_DEFINITIONS_SCHEMA as Ot, TABLE_AGENT_VERSIONS as P, listScoresResponseSchema as Pn, INPUT_PREVIEW_MAX_LENGTH as Pt, TABLE_MCP_CLIENTS as Q, getSpanArgsSchema as Qt, TABLE_CONFIGS as R, scoringEntityTypeSchema as Rn, batchDeleteTracesResponseSchema as Rt, OBSERVATIONAL_MEMORY_TABLE_SCHEMA as S, tracesFilterSchema as Sn, TABLE_WORKFLOW_DEFINITIONS as St, PROMPT_BLOCK_VERSIONS_SCHEMA as T, updateSpanArgsSchema as Tn, TABLE_WORKSPACE_VERSIONS as Tt, TABLE_EXPERIMENT_RESULTS as U, scoringInputWithExtractStepResultAndScoreAndReasonSchema as Un, buildInputPreview as Ut, TABLE_DATASET_VERSIONS as V, scoringInputSchema as Vn, branchesOrderByFieldSchema as Vt, TABLE_FAVORITES as W, scoringInputWithExtractStepResultSchema as Wn, computeTraceStatus as Wt, TABLE_KNOWLEDGE_RECORDS as X, getRootSpanArgsSchema as Xt, TABLE_KNOWLEDGE_NODES as Y, getBranchResponseSchema as Yt, TABLE_KNOWLEDGE_SEMANTIC_OUTBOX as Z, getRootSpanResponseSchema as Zt, MCP_CLIENT_VERSIONS_SCHEMA as _, spanRecordSchema as _n, TABLE_SPANS as _t, DATASET_VERSIONS_SCHEMA as a, getTraceResponseSchema as an, TABLE_PROMPT_BLOCKS as at, NOTIFICATIONS_SCHEMA as b, toTraceSpans as bn, TABLE_TOOL_PROVIDER_CONNECTIONS as bt, FAVORITES_SCHEMA as c, listBranchesResponseSchema as cn, TABLE_SCHEDULES as ct, KNOWLEDGE_CURSORS_SCHEMA as d, listTracesLightResponseSchema as dn, TABLE_SCORERS as dt, getSpansArgsSchema as en, TABLE_MCP_SERVERS as et, KNOWLEDGE_MENTIONS_SCHEMA as f, listTracesResponseSchema as fn, TABLE_SCORER_DEFINITIONS as ft, MCP_CLIENTS_SCHEMA as g, spanIdsSchema as gn, TABLE_SKILL_VERSIONS as gt, KNOWLEDGE_SEMANTIC_OUTBOX_SCHEMA as h, spanIds as hn, TABLE_SKILL_BLOBS as ht, DATASET_ITEMS_SCHEMA as i, getTraceLightResponseSchema as in, TABLE_OBSERVATIONAL_MEMORY as it, SKILL_VERSIONS_SCHEMA as j, extractTrajectory as jn, BATCH_DELETE_TRACES_MAX_IDS as jt, SKILLS_SCHEMA as k, buildStorageSchema as kn, WORKSPACES_SCHEMA as kt, HARNESS_SESSIONS_SCHEMA as l, listScoresBySpanResponseSchema as ln, TABLE_SCHEDULE_TRIGGERS as lt, KNOWLEDGE_RECORDS_SCHEMA as m, scoreTracesResponseSchema as mn, TABLE_SKILLS as mt, AGENT_VERSIONS_SCHEMA as n, getStructureResponseSchema as nn, TABLE_MESSAGES as nt, EXPERIMENTS_SCHEMA as o, lightSpanRecordSchema as on, TABLE_PROMPT_BLOCK_VERSIONS as ot, KNOWLEDGE_NODES_SCHEMA as p, scoreTracesRequestSchema as pn, TABLE_SCORER_DEFINITION_VERSIONS as pt, TABLE_KNOWLEDGE_CURSORS as q, scoringValueSchema as qn, extractBranchSpans as qt, DATASETS_SCHEMA as r, getTraceArgsSchema as rn, TABLE_NOTIFICATIONS as rt, EXPERIMENT_RESULTS_SCHEMA as s, listBranchesArgsSchema as sn, TABLE_RESOURCES as st, AGENTS_SCHEMA as t, getSpansResponseSchema as tn, TABLE_MCP_SERVER_VERSIONS as tt, KNOWLEDGE_ACTIVITY_SCHEMA as u, listTracesArgsSchema as un, TABLE_SCHEMAS as ut, MCP_SERVERS_SCHEMA as v, toLightSpanRecord as vn, TABLE_THREADS as vt, PROMPT_BLOCKS_SCHEMA as w, tracesOrderBySchema as wn, TABLE_WORKSPACES as wt, OBSERVATIONAL_MEMORY_SCHEMA as x, traceSpanSchema as xn, TABLE_TRACES as xt, MCP_SERVER_VERSIONS_SCHEMA as y, toTraceSpan as yn, TABLE_THREAD_STATE as yt, TABLE_DATASETS as z, scoringExtractStepResultSchema as zn, batchUpdateSpansArgsSchema as zt };

//# sourceMappingURL=constants-DpwJBCXp.js.map