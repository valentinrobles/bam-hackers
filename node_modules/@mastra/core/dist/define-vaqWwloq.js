...
function assertValidScheduleDefinition(definition, label) {
	...
	if (!definition || typeof definition !== "object") throw new MastraError({
	...
	if (hasPrompt && hasHandler) throw new MastraError({
	...
	if (definition.signalType !== void 0 && !SCHEDULE_SIGNAL_TYPES.includes(definition.signalType)) throw new MastraError({
	...
	if (definition.status !== void 0 && !SCHEDULE_STATUSES.includes(definition.status)) throw new MastraError({
	...
	if (definition.threadId && !definition.resourceId) throw new MastraError({
...
//#endregion
export { parseFsAgentScheduleRowId as a, ScheduleOutputSchema as c, fsAgentScheduleRowId as i, WORKFLOW_SCHEDULE_PREFIX as l, assertValidScheduleDefinition as n, AGENT_SCHEDULE_PREFIX as o, defineSchedule as r, ScheduleInputSchema as s, FS_AGENT_SCHEDULE_PREFIX as t };

//# sourceMappingURL=define-vaqWwloq.js.map