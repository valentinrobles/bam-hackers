...
var forbiddenParamSchema = lazyValidator(() => zodSchema(zod_v4.z.object({ ruleId: zod_v4.z.string() })));
var _a3$1;
var _b3;
...
var modelNotFoundParamSchema = lazyValidator(() => zodSchema(zod_v4.z.object({ modelId: zod_v4.z.string() })));
var _a6$1;
var _b6;
...
var gatewayErrorResponseSchema = lazyValidator(() => zodSchema(zod_v4.z.object({ error: zod_v4.z.object({
...
var gatewayAuthMethodSchema = lazyValidator(() => zodSchema(zod_v4.z.union([zod_v4.z.literal("api-key"), zod_v4.z.literal("oidc")])));
...
var gatewayAvailableModelsResponseSchema = lazyValidator(() => zodSchema(zod_v4.z.object({ models: zod_v4.z.array(zod_v4.z.object({
	id: zod_v4.z.string(),
	...
	specification: zod_v4.z.object({
		specificationVersion: zod_v4.z.literal("v2"),
...
var gatewayCreditsResponseSchema = lazyValidator(() => zodSchema(zod_v4.z.object({
...
var gatewayEmbeddingResponseSchema = lazyValidator(() => zodSchema(zod_v4.z.object({
...
var gatewayImageResponseSchema = zod_v4.z.object({
	...
	warnings: zod_v4.z.array(zod_v4.z.object({
...
var parallelSearchToolFactory = createProviderDefinedToolFactoryWithOutputSchema({
	...
	inputSchema: lazySchema(() => zodSchema(zod.z.object({
		...
		source_policy: zod.z.object({
			...
			after_date: zod.z.string().optional().describe("Only include results published after this date (ISO 8601 format).")
...
var providerMetadataSchema = zod_v4.z.record(zod_v4.z.string(), zod_v4.z.record(zod_v4.z.string(), jsonValueSchema));
...
var outputSchema = zod_v4.z.discriminatedUnion("type", [
	...
	zod_v4.z.object({
		...
		value: zod_v4.z.array(zod_v4.z.union([zod_v4.z.object({
			type: zod_v4.z.literal("text"),
			text: zod_v4.z.string()
		}), zod_v4.z.object({
...
var toolModelMessageSchema = zod_v4.z.object({
	...
	content: zod_v4.z.array(toolResultPartSchema),
	providerOptions: providerMetadataSchema.optional()
});
zod_v4.z.union([
...
Object.defineProperty(exports, "convertToModelMessages", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "generateSpeech", {
	enumerable: true,
	get: function() {
		return generateSpeech;
	}
});
Object.defineProperty(exports, "isDeepEqualData", {
	enumerable: true,
	get: function() {
		return isDeepEqualData;
	}
});
Object.defineProperty(exports, "isToolUIPart", {
	enumerable: true,
	get: function() {
		return isToolUIPart;
	}
...
//# sourceMappingURL=dist-Bp60ptfZ.cjs.map