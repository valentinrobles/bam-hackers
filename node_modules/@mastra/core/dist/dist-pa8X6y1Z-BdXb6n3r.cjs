...
var forbiddenParamSchema = lazySchema(() => zodSchema(zod_v4.z.object({ ruleId: zod_v4.z.string() })));
var _a8;
var _b8;
...
var gatewayErrorResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	error: zod_v4.z.object({
		...
		param: zod_v4.z.unknown().nullish(),
		code: zod_v4.z.union([zod_v4.z.string(), zod_v4.z.number()]).nullish()
	}),
	generationId: zod_v4.z.string().nullish()
})));
...
var gatewayAvailableModelsResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({ models: zod_v4.z.array(zod_v4.z.object({
	...
	pricing: zod_v4.z.object({
		input: zod_v4.z.string(),
		output: zod_v4.z.string(),
		input_cache_read: zod_v4.z.string().nullish(),
		input_cache_write: zod_v4.z.string().nullish()
	...
	specification: zod_v4.z.object({
		specificationVersion: zod_v4.z.literal("v3"),
...
var gatewaySpendReportResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({ results: zod_v4.z.array(zod_v4.z.object({
	...
	tag: zod_v4.z.string().optional(),
	provider: zod_v4.z.string().optional(),
	credential_type: zod_v4.z.enum(["byok", "system"]).optional(),
	total_cost: zod_v4.z.number(),
	market_cost: zod_v4.z.number().optional(),
	input_tokens: zod_v4.z.number().optional(),
	output_tokens: zod_v4.z.number().optional(),
	cached_input_tokens: zod_v4.z.number().optional(),
	cache_creation_input_tokens: zod_v4.z.number().optional(),
	reasoning_tokens: zod_v4.z.number().optional(),
	request_count: zod_v4.z.number().optional()
...
var gatewayGenerationInfoResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({ data: zod_v4.z.object({
	...
	usage: zod_v4.z.number(),
	created_at: zod_v4.z.string(),
	model: zod_v4.z.string(),
	is_byok: zod_v4.z.boolean(),
	provider_name: zod_v4.z.string(),
	streamed: zod_v4.z.boolean(),
	finish_reason: zod_v4.z.string(),
	latency: zod_v4.z.number(),
	generation_time: zod_v4.z.number(),
	native_tokens_prompt: zod_v4.z.number(),
	native_tokens_completion: zod_v4.z.number(),
	native_tokens_reasoning: zod_v4.z.number(),
	native_tokens_cached: zod_v4.z.number(),
	native_tokens_cache_creation: zod_v4.z.number(),
	billable_web_search_calls: zod_v4.z.number()
	...
	async doGenerate(options) {
		...
		try {
			const { responseHeaders, value: responseBody, rawValue: rawResponse } = await postJsonToApi({
				...
				body: args,
				successfulResponseHandler: createJsonResponseHandler(zod_v4.z.any()),
				failedResponseHandler: createJsonErrorResponseHandler({
					errorSchema: zod_v4.z.any(),
					errorToMessage: (data) => data
				}),
	...
	async doStream(options) {
		...
		try {
			const { value: response, responseHeaders } = await postJsonToApi({
				...
				body: args,
				successfulResponseHandler: createEventSourceResponseHandler(zod_v4.z.any()),
				failedResponseHandler: createJsonErrorResponseHandler({
					errorSchema: zod_v4.z.any(),
					errorToMessage: (data) => data
				}),
...
var gatewayEmbeddingWarningSchema = zod_v4.z.discriminatedUnion("type", [
	zod_v4.z.object({
		type: zod_v4.z.literal("unsupported"),
		feature: zod_v4.z.string(),
		details: zod_v4.z.string().optional()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("compatibility"),
		feature: zod_v4.z.string(),
		details: zod_v4.z.string().optional()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("other"),
		message: zod_v4.z.string()
	})
]);
var gatewayEmbeddingResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	...
	providerMetadata: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.record(zod_v4.z.string(), zod_v4.z.unknown())).optional()
})));
...
var providerMetadataEntrySchema = zod_v4.z.object({ images: zod_v4.z.array(zod_v4.z.unknown()).optional() }).catchall(zod_v4.z.unknown());
var gatewayImageWarningSchema = zod_v4.z.discriminatedUnion("type", [
	zod_v4.z.object({
		type: zod_v4.z.literal("unsupported"),
		feature: zod_v4.z.string(),
		details: zod_v4.z.string().optional()
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("deprecated"),
		setting: zod_v4.z.string(),
		message: zod_v4.z.string()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("other"),
...
var gatewayImageUsageSchema = zod_v4.z.object({
	inputTokens: zod_v4.z.number().nullish(),
	outputTokens: zod_v4.z.number().nullish(),
	totalTokens: zod_v4.z.number().nullish()
});
var gatewayImageResponseSchema = zod_v4.z.object({
	images: zod_v4.z.array(zod_v4.z.string()),
	warnings: zod_v4.z.array(gatewayImageWarningSchema).optional(),
	providerMetadata: zod_v4.z.record(zod_v4.z.string(), providerMetadataEntrySchema).optional(),
...
var providerMetadataEntrySchema2 = zod_v4.z.object({ videos: zod_v4.z.array(zod_v4.z.unknown()).optional() }).catchall(zod_v4.z.unknown());
var gatewayVideoDataSchema = zod_v4.z.union([zod_v4.z.object({
...
var gatewayVideoWarningSchema = zod_v4.z.discriminatedUnion("type", [
	zod_v4.z.object({
		type: zod_v4.z.literal("unsupported"),
		feature: zod_v4.z.string(),
		details: zod_v4.z.string().optional()
...
var gatewayVideoEventSchema = zod_v4.z.discriminatedUnion("type", [zod_v4.z.object({
	type: zod_v4.z.literal("result"),
	videos: zod_v4.z.array(gatewayVideoDataSchema),
	warnings: zod_v4.z.array(gatewayVideoWarningSchema).optional(),
	providerMetadata: zod_v4.z.record(zod_v4.z.string(), providerMetadataEntrySchema2).optional()
}), zod_v4.z.object({
	type: zod_v4.z.literal("error"),
	message: zod_v4.z.string(),
	errorType: zod_v4.z.string(),
	statusCode: zod_v4.z.number(),
	param: zod_v4.z.unknown().nullable()
})]);
...
var gatewayRerankingWarningSchema = zod_v4.z.discriminatedUnion("type", [
	zod_v4.z.object({
		type: zod_v4.z.literal("unsupported"),
		feature: zod_v4.z.string(),
		details: zod_v4.z.string().optional()
...
var gatewayRerankingResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	...
	warnings: zod_v4.z.array(gatewayRerankingWarningSchema).optional(),
	providerMetadata: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.record(zod_v4.z.string(), zod_v4.z.unknown())).optional()
})));
...
var providerMetadataEntrySchema3 = zod_v4.z.object({}).catchall(zod_v4.z.unknown());
var gatewaySpeechWarningSchema = zod_v4.z.discriminatedUnion("type", [
	zod_v4.z.object({
		type: zod_v4.z.literal("unsupported"),
		feature: zod_v4.z.string(),
		details: zod_v4.z.string().optional()
...
var gatewaySpeechResponseSchema = zod_v4.z.object({
	audio: zod_v4.z.string(),
	warnings: zod_v4.z.array(gatewaySpeechWarningSchema).optional(),
	providerMetadata: zod_v4.z.record(zod_v4.z.string(), providerMetadataEntrySchema3).optional()
});
...
var providerMetadataEntrySchema4 = zod_v4.z.object({}).catchall(zod_v4.z.unknown());
var gatewayTranscriptionWarningSchema = zod_v4.z.discriminatedUnion("type", [
	zod_v4.z.object({
		type: zod_v4.z.literal("unsupported"),
		feature: zod_v4.z.string(),
		details: zod_v4.z.string().optional()
...
var gatewayTranscriptionResponseSchema = zod_v4.z.object({
	text: zod_v4.z.string(),
	segments: zod_v4.z.array(zod_v4.z.object({
		text: zod_v4.z.string(),
		startSecond: zod_v4.z.number(),
		endSecond: zod_v4.z.number()
	})).optional(),
	language: zod_v4.z.string().nullish(),
	durationInSeconds: zod_v4.z.number().nullish(),
	warnings: zod_v4.z.array(gatewayTranscriptionWarningSchema).optional(),
	providerMetadata: zod_v4.z.record(zod_v4.z.string(), providerMetadataEntrySchema4).optional()
});
	...
	inputSchema: lazySchema(() => zodSchema(zod.z.object({
		...
		contents: zod.z.object({
			text: zod.z.union([zod.z.boolean(), zod.z.object({
				...
				include_sections: zod.z.array(zod.z.enum([
					"header",
					"navigation",
					"banner",
					"body",
				...
				exclude_sections: zod.z.array(zod.z.enum([
					"header",
					"navigation",
					"banner",
					"body",
...
var parallelSearchToolFactory = createProviderToolFactoryWithOutputSchema({
	...
	inputSchema: lazySchema(() => zodSchema(zod.z.object({
		...
		max_results: zod.z.number().optional().describe("Maximum number of results to return (1-20). Defaults to 10 if not specified."),
		source_policy: zod.z.object({
			include_domains: zod.z.array(zod.z.string()).optional().describe("Limit results to these domains. Use plain domain names only — e.g. example.com or sub.example.gov, or a bare extension like .edu. Do not include a scheme, path, or port (e.g. not https://example.com/page)."),
			exclude_domains: zod.z.array(zod.z.string()).optional().describe("Exclude results from these domains. Use plain domain names only — e.g. example.com or sub.example.gov, or a bare extension like .edu. Do not include a scheme, path, or port (e.g. not https://example.com/page)."),
			after_date: zod.z.string().optional().describe("Only include results published after this date. Use an ISO 8601 calendar date formatted YYYY-MM-DD (e.g. 2025-01-01); do not include a time.")
...
var perplexitySearchToolFactory = createProviderToolFactoryWithOutputSchema({
	...
	inputSchema: lazySchema(() => zodSchema(zod.z.object({
		...
		max_tokens: zod.z.number().optional().describe("Maximum total tokens across all search results (default: 25000, max: 1000000)"),
		country: zod.z.string().optional().describe("Two-letter ISO 3166-1 alpha-2 country code for regional search results (e.g., 'US', 'GB', 'FR')"),
		search_domain_filter: zod.z.array(zod.z.string()).optional().describe("List of domains to include or exclude from search results (max 20). To include: ['nature.com', 'science.org']. To exclude: ['-example.com', '-spam.net']"),
		search_language_filter: zod.z.array(zod.z.string()).optional().describe("List of ISO 639-1 language codes to filter results (max 10, lowercase). Examples: ['en', 'fr', 'de']"),
		search_after_date: zod.z.string().optional().describe("Include only results published after this date. Format: 'MM/DD/YYYY' (e.g., '3/1/2025'). Cannot be used with search_recency_filter."),
		search_before_date: zod.z.string().optional().describe("Include only results published before this date. Format: 'MM/DD/YYYY' (e.g., '3/15/2025'). Cannot be used with search_recency_filter."),
		last_updated_after_filter: zod.z.string().optional().describe("Include only results last updated after this date. Format: 'MM/DD/YYYY' (e.g., '3/1/2025'). Cannot be used with search_recency_filter."),
		last_updated_before_filter: zod.z.string().optional().describe("Include only results last updated before this date. Format: 'MM/DD/YYYY' (e.g., '3/15/2025'). Cannot be used with search_recency_filter."),
		search_recency_filter: zod.z.enum([
			"day",
			"week",
			"month",
			"year"
...
Object.defineProperty(exports, "DEFAULT_MAX_DOWNLOAD_SIZE", {
	enumerable: true,
	get: function() {
		return DEFAULT_MAX_DOWNLOAD_SIZE;
	}
});
...
Object.defineProperty(exports, "GatewayAuthenticationError", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "asSchema", {
	enumerable: true,
	get: function() {
		return asSchema;
	}
...
Object.defineProperty(exports, "createGatewayProvider", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "executeTool", {
	enumerable: true,
	get: function() {
		return executeTool;
	}
});
Object.defineProperty(exports, "fetchWithValidatedRedirects", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "getErrorMessage$1", {
	enumerable: true,
	get: function() {
		return getErrorMessage$1;
	}
});
Object.defineProperty(exports, "getRuntimeEnvironmentUserAgent", {
	enumerable: true,
	get: function() {
		return getRuntimeEnvironmentUserAgent;
	}
});
...
Object.defineProperty(exports, "isUrlSupported", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "readResponseWithSizeLimit", {
	enumerable: true,
	get: function() {
		return readResponseWithSizeLimit;
	}
});
...
Object.defineProperty(exports, "retryWithExponentialBackoff", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "safeValidateTypes", {
	enumerable: true,
	get: function() {
...
//# sourceMappingURL=dist-pa8X6y1Z-BdXb6n3r.cjs.map