...
const require_model = require("./model-DgsnIPGn.cjs");
...
const require_provider_registry = require("./provider-registry-BYH6y4zy.cjs");
	...
	*/
	...
	async doStream(options) {
		...
		if (isLanguageModelV4(model)) {
			...
			require_types.attachModelStreamTransport(streamResult, streamTransport);
			return streamResult;
		}
...
//# sourceMappingURL=llm-DTp5hqfJ.cjs.map