...
const createCustomTransport = (stream$1, listLogs, listLogsByRunId) => {
	let transport = stream$1;
...
Object.defineProperty(exports, "buildLogRecordData", {
	enumerable: true,
	get: function() {
		return buildLogRecordData;
	}
});
...
Object.defineProperty(exports, "exportTrackedException", {
	enumerable: true,
	get: function() {
		return exportTrackedException;
	}
});
Object.defineProperty(exports, "isAdaptableLogger", {
	enumerable: true,
	get: function() {
		return isAdaptableLogger;
	}
});

//# sourceMappingURL=logger-D7H1yreU.cjs.map