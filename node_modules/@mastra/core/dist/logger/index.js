import { a as RegisteredLogger, c as exportTrackedException, i as MastraLogger, l as isAdaptableLogger, n as LogLevel, o as buildLogRecordData, r as LoggerTransport, s as createCustomTransport, t as ConsoleLogger } from "../logger-DGUE8DHx.js";
import { c as resolveCurrentSpan, l as resolveExportedSpanId } from "../utils-C64E0GKG.js";
...
var MultiLogger = class {
	...
	*/
	__attachObservability(ctx) {
		...
		for (const logger of this.loggers) if (isAdaptableLogger(logger)) logger.__attachObservability(childCtx);
	}
...
//#endregion
export { ConsoleLogger, DualLogger, LogLevel, LoggerTransport, MastraLogger, MultiLogger, RegisteredLogger, buildLogRecordData, createCustomTransport, createExportSuppressedLogger, createLogger, exportTrackedException, isAdaptableLogger, isObservabilityExportSuppressed, noopLogger, resolveTraceFields };
