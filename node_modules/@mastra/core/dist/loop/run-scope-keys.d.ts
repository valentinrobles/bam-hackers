 ...
 */
import type { IdGenerator, ModelMessage, ToolSet } from '../_types/@internal_ai-sdk-v5/dist/index.d.ts';
...
export declare const STEP_MODEL_MESSAGES_KEY: import("../mastra/run-scope").RunScopeKey<ModelMessage[]>;
