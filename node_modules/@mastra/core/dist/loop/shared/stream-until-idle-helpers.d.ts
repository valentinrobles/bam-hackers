...
export declare const TERMINAL_BG_CHUNKS: Set<string>;
 ...
 */
export declare function resolveScope(agent: {
    getMemory: (opts?: any) => Promise<MastraMemory | undefined>;
}, mergedOptions: Record<string, any>): Promise<ResolvedScope | null>;
/**
 ...
 */
export declare function buildContinuationDirective(batch: Array<Record<string, unknown>>): string;
/**
 ...
 * future turns.
 */
export declare function buildContinuationOpts(baseContinuationOpts: Record<string, any>, callerContext: any[] | undefined, batch: Array<Record<string, unknown>>): Record<string, any>;
/**
 * Register `closer` as the active wrapper for `scopeKey`, aborting any
 * prior registered closer first. No-op for null scopes.
 */
export declare function acquireStreamSlot(activeStreams: Map<string, () => void>, scopeKey: string | null, closer: () => void): void;
/**
 ...
 */
export declare function releaseStreamSlot(activeStreams: Map<string, () => void>, scopeKey: string | null, closer: () => void): void;
 ...
 */
export declare function runIdleLoop<TAgent extends {
    id: string;
    getDefaultOptions: (opts?: any) => any | Promise<any>;
    getMemory: (opts?: any) => Promise<MastraMemory | undefined>;
}, TFirstResult extends {
    fullStream: any;
}, TReturn>(agent: TAgent, streamOptions: (Record<string, any> & {
    maxIdleMs?: number;
}) | undefined, deps: IdleLoopDeps, firstTurn: (opts: Record<string, any>) => Promise<TFirstResult>, streamForContinuation: (opts: Record<string, any>) => Promise<{
    fullStream: ReadableStream<any>;
}>, buildResult: (first: TFirstResult, ctx: IdleLoopContext) => TReturn, hooks?: PostPipeHooks): Promise<TReturn>;
//# sourceMappingURL=stream-until-idle-helpers.d.ts.map