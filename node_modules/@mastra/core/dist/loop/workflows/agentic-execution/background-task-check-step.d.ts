 ...
 */
export declare function createBackgroundTaskCheckStep<Tools extends ToolSet = ToolSet, OUTPUT = undefined>({ _internal, controller, runId, agentId, mastra, }: OuterLLMRun<Tools, OUTPUT>): import("../../../workflows").Step<"backgroundTaskCheckStep", unknown, {
    messageId: string;
    messages: {
        all: any[];
        user: any[];
