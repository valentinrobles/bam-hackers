 ...
 */
export declare function createGoalStep<Tools extends ToolSet = ToolSet, OUTPUT = undefined>(params: OuterLLMRun<Tools, OUTPUT>): import("../../../workflows").Step<"goalStep", unknown, {
    messageId: string;
    messages: {
        all: any[];
        user: any[];
...
//# sourceMappingURL=goal-step.d.ts.map