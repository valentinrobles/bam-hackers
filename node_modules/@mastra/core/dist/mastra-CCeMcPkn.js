import { l as isAdaptableLogger, n as LogLevel, t as ConsoleLogger } from "./logger-DGUE8DHx.js";
import { t as InMemoryServerCache } from "./inmemory-D_cTX1px.js";
...
import { n as isRunLocalTopic } from "./topics-BnSN0uEb.js";
import { d as NoOpObservability, f as noOpLoggerContext, p as noOpMetricsContext } from "./observability-DlWHQwp0.js";
import { c as resolveCurrentSpan } from "./utils-C64E0GKG.js";
import { r as trackFeatureUsage } from "./feature-telemetry-C4P71GGd.js";
import { s as BackgroundTaskManager } from "./background-tasks-Dt8uUqZI.js";
import { _ as readPositiveIntEnv } from "./utils-CyZ0Xi-1.js";
import { At as createRunScope, En as createWorkflow, J as AgentChannels, Ot as augmentWithInit, Tn as createStep, fn as createOnScorerHook, mr as isDurableAgentLike, p as __registerMastraCtor } from "./agent-Dk0N0Nlg.js";
import { r as normalizeToolPayloadTransformPolicy } from "./payload-transform-C4k4-WlM.js";
import { c as defaultGateways } from "./llm-Oy59omd7.js";
...
import { t as Schedules } from "./schedules-CDNLDdCZ.js";
import { DualLogger, createExportSuppressedLogger, isObservabilityExportSuppressed, noopLogger, resolveTraceFields } from "./logger/index.js";
import { r as computeScheduleDefinitionHash, t as WorkflowEventProcessor } from "./workflow-event-processor-BSZt3kfu.js";
import { a as registerHook, r as deregisterHook } from "./hooks-s8qUTtbg.js";
import { l as WorkflowsInMemory, ot as BackgroundTasksInMemory, s as InMemoryStore } from "./storage-i0AbUuW_.js";
import { r as InMemoryDB } from "./source-B-1fjDaP.js";
import { g as agentThreadStreamRuntime, r as dispatchDueNotifications } from "./storage-MbGlKLkB.js";
import { Y as getActiveDurableAgentWorkflowExecutions, t as createDurableAgent } from "./create-durable-agent-DFHwqN2K.js";
import { t as DatasetsManager } from "./manager-DQo826hB.js";
import { LicenseClient } from "./license/index.js";
import { initContextStorage } from "./observability/context-storage.js";
import { r as isToolLoopAgentLike, t as toolLoopAgentToMastraAgent } from "./tool-loop-agent-D4Ez45dL.js";
import { n as assertDrainTimeout } from "./pull-transport-D6pSbsAj.js";
import { i as OrchestrationWorker, n as BackgroundTaskWorker, r as SchedulerWorker } from "./worker-DwqFCYCm.js";
import { n as normalizeWorkflowBuilderDefinition } from "./builder-BLZ7KikU.js";
import { d as toJsonSchemaOrUndefined, p as collectNestedWorkflowIds, t as assertValidDynamicWorkflow } from "./validate-DCRkW3Cu.js";
import { t as rehydrateWorkflow } from "./rehydrate-BFt1vhJy.js";
...
var Mastra = class Mastra {
	...
	async #startSchedulingWorkers() {
		...
		if (!this.#workerFilter || this.#workerFilter.has("agent-schedule")) {
			...
			if (!agentScheduleWorker) {
				const { AgentScheduleWorker } = await import("./worker-CemmWBp9.js");
	...
	#wireLoggerObservability(logger) {
		...
		if (isAdaptableLogger(inner)) {
			...
			inner.__attachObservability({
				resolveTraceFields,
				getLogSink: () => {
					if (!this.#loggerAdapterOptions.export || isObservabilityExportSuppressed()) return void 0;
		...
		if (inner instanceof DualLogger) return this.#wireLoggerObservability(inner.baseLogger);
		...
		const wrapper = new DualLogger(inner, this.#loggerAdapterOptions.export ? () => this.#observability.getDefaultInstance()?.getLoggerContext?.() : void 0);
	...
	*/
	#observabilitySafeLogger() {
		return createExportSuppressedLogger(this.#logger instanceof DualLogger ? this.#logger.baseLogger : this.#logger);
	}
	/**
	...
	*/
	#syncGatewayRegistry() {
		try {
			...
			import("./provider-registry-BFx643fQ.js").then((n) => n.u).then(async ({ GatewayRegistry }) => {
	...
	*/
	async shutdown(options) {
		...
		for (;;) {
			const pendingRuns = [...this.#activeEventedRuns, ...getActiveDurableAgentWorkflowExecutions(this)].filter((run) => !awaited.has(run));
...
//# sourceMappingURL=mastra-CCeMcPkn.js.map