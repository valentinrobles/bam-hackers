	...
	async resolveLanguageModel({ modelId, providerId, apiKey, headers }) {
		...
		switch (providerId) {
			...
			case "perplexity": return createPerplexity({
				apiKey,
				baseURL,
				headers: Object.keys(mastraHeaders).some((key) => key.toLowerCase() === "x-pplx-integration") ? mastraHeaders : {
...
//# sourceMappingURL=models-dev-BiPr0PJE.js.map