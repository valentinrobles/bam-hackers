		...
		switch (providerId) {
			...
			case "perplexity": return createPerplexity({
				...
				headers: Object.keys(mastraHeaders).some((key) => key.toLowerCase() === "x-pplx-integration") ? mastraHeaders : {
					"X-Pplx-Integration": require_dist.MASTRA_USER_AGENT,
					...mastraHeaders
				}
			})(modelId);
			...
			case "vercel": return require_dist_pa8X6y1Z.createGatewayProvider({
				apiKey,
				baseURL,
				headers: mastraHeaders
			})(modelId);
...
//# sourceMappingURL=models-dev-DwimeuYR.cjs.map