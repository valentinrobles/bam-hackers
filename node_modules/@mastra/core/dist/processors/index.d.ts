...
import type { StepResult, ToolChoice } from '../_types/@internal_ai-sdk-v5/dist/index.d.ts';
...
import type { ModelRouterModelId, MastraModelSettings } from '../llm/model/index.js';
...
import type { ObservabilityContext, ProcessorSpanType, SpanTypeMap, TracingContext } from '../observability/index.js';
 ...
 */
export type ProcessorSpanPhase = 'input' | 'inputStep' | 'llmRequest' | 'llmResponse' | 'output' | 'outputStep' | 'toolResult' | 'requestError';
export interface Processor<TId extends string = string, TTripwireMetadata = unknown> {
     ...
     * compile time.
     */
    readonly spanAttributes?: Partial<SpanTypeMap[ProcessorSpanType]> | ((phase: ProcessorSpanPhase) => Partial<SpanTypeMap[ProcessorSpanType]>);
...
export { createBackgroundWorkSignalProcessor } from './background-work-signals.js';
export type { BackgroundWorkDisposition, BackgroundWorkInvocationKind, BackgroundWorkLifecyclePayload, BackgroundWorkTerminalStatus, } from './background-work-signals.js';
