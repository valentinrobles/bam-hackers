...
import type { StepResult, ToolChoice, ToolSet } from '../_types/@internal_ai-sdk-v5/dist/index.d.ts';
...
export type ProcessorStepInputType = ProcessorInputPhaseType | ProcessorInputStepPhaseType | ProcessorOutputStreamPhaseType | ProcessorOutputResultPhaseType | ProcessorOutputStepPhaseType | ProcessorToolResultPhaseType;
...
export declare const ProcessorInputStepPhaseSchema: z.ZodObject<{
    ...
    modelSettings: z.ZodOptional<z.ZodCustom<MastraModelSettings, MastraModelSettings>>;
 ...
 */
export declare const ProcessorToolResultPhaseSchema: z.ZodObject<{
    phase: z.ZodLiteral<"toolResult">;
    messages: z.ZodArray<z.ZodType<ProcessorMessageType, unknown, z.core.$ZodTypeInternals<ProcessorMessageType, unknown>>>;
    messageList: z.ZodCustom<MessageList, MessageList>;
    stepNumber: z.ZodNumber;
    toolName: z.ZodString;
