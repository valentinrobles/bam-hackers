...
import { c as MastraModelGateway, i as MASTRA_USER_AGENT, o as createAnthropic, r as GATEWAY_AUTH_HEADER } from "./dist-BESwrsHG.js";
import { a as getCapabilityFileName, i as shouldEnableGateway, n as getGatewayId } from "./gateway-helpers-Dh-2ojNA.js";
import { i as createOpenRouter, t as ModelsDevGateway } from "./models-dev-BiPr0PJE.js";
import { t as NetlifyGateway } from "./netlify-CR63WazZ.js";
...
function withGatewayAuthHeader(apiKey, headers) {
	...
	const result = { "User-Agent": MASTRA_USER_AGENT };
...
var GatewayRegistry = class GatewayRegistry {
	...
	*/
	async syncGateways(forceRefresh = false, writeToSrc = false) {
		...
		try {
			const { ModelsDevGateway } = await import("./models-dev-BiPr0PJE.js").then((n) => n.n);
			const { NetlifyGateway } = await import("./netlify-CR63WazZ.js").then((n) => n.n);
			const { MastraGateway } = await Promise.resolve().then(() => mastra_exports);
			const { fetchProvidersFromGateways, writeRegistryFiles } = await import("./registry-generator-DTVbvs_S.js");
...
//# sourceMappingURL=provider-registry-BFx643fQ.js.map