...
const require_dist = require("./dist-DVNEQLs3.cjs");
const require_gateway_helpers = require("./gateway-helpers-B_IPtGRQ.cjs");
const require_models_dev = require("./models-dev-DwimeuYR.cjs");
const require_netlify = require("./netlify-jtLUgvwg.cjs");
let os = require("os");
...
*/
function withGatewayAuthHeader(apiKey, headers) {
	const reserved = require_dist.GATEWAY_AUTH_HEADER.toLowerCase();
	const result = { "User-Agent": require_dist.MASTRA_USER_AGENT };
	for (const [key, value] of Object.entries(headers ?? {})) {
		if (key.toLowerCase() === reserved) continue;
		result[key] = value;
	}
	result[require_dist.GATEWAY_AUTH_HEADER] = `Bearer ${apiKey}`;
	return result;
}
...
var provider_registry_default = {
	providers: {
		...
		"tokengo": {
			...
			"docUrl": "https://www.tokengo.com/docs",
			"gateway": "models.dev"
		},
		"modelis": {
		...
		"agentrouter": {
			...
			"docUrl": "https://agentrouter.org/docs/opencode.html",
			"gateway": "models.dev",
			"modelOverrides": {
				"claude-opus-5": {
		...
		"aixy": {
			...
			"apiKeyEnvVar": "AIXY_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "Aixy",
			"models": ["openai/gpt-4.1-mini"],
			"docUrl": "https://docs.aixy-gateway.com/integrations/overview",
			"gateway": "models.dev"
		},
		"impossibl": {
		...
		"alibaba-token-plan": {
			...
			"gateway": "models.dev",
			"deprecatedModels": ["qwen3.8-max-preview"]
		},
		"neuralwatt": {
		...
		"llmtech": {
			...
			"apiKeyEnvVar": "LLMTECH_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "LLM Tech",
			"models": ["unsloth/Qwen3.8-27B-NVFP4"],
			"docUrl": "https://llmtech.eu/models/qwen3.8-27b",
			"gateway": "models.dev"
		},
		...
		"infer": {
			...
			"apiKeyEnvVar": "INFER_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "Infer by Flow7",
			"models": ["infer/gpt-5.6-sol:official", "infer/gpt-6-astra:official"],
			"docUrl": "https://infer.flow7.org/opencode",
			"gateway": "models.dev",
			"npm": "@ai-sdk/openai",
			"modelOverrides": {
				"infer/gpt-5.6-sol:official": { "shape": "responses" },
				"infer/gpt-6-astra:official": { "shape": "responses" }
			}
		},
		"stepfun-ai": {
		...
		"pendra": {
			...
			"docUrl": "https://pendra.ai/docs/integrations/opencode",
			"gateway": "models.dev"
		},
		"above": {
			"url": "https://api.above.dev/v1",
			"apiKeyEnvVar": "ABOVE_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "above.dev",
			"models": [
				"deepseek-v4-flash",
		...
		"tokenrouter": {
			...
			"docUrl": "https://www.tokenrouter.com/docs/tokenrouter-feature-guide/",
			"gateway": "models.dev"
		},
		"thinkingmachines": {
		...
		"standardcompute": {
			...
			"apiKeyEnvVar": "STANDARDCOMPUTE_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "Standard Compute",
			"models": ["standardcompute"],
			"docUrl": "https://standardcompute.com/models",
			"gateway": "models.dev"
		},
		"tensorx": {
		...
		"crof": {
			...
			"gateway": "models.dev",
			"modelOverrides": {
				"deepseek-v4-flash-vision-exp": { "npm": "@ai-sdk/openai-compatible" },
				"deepseek-v4-pro-0813": { "npm": "@ai-sdk/openai-compatible" },
				"deepseek-v4-flash-0731": { "npm": "@ai-sdk/openai-compatible" },
				"qwen3.8-27b": { "npm": "@ai-sdk/openai-compatible" },
		...
		"klokintegration": {
			...
			"apiKeyEnvVar": "KLOKINTEGRATION_API_KEY",
			"apiKeyHeader": "Authorization",
			...
			"docUrl": "https://klokintegration.se/docs/ai-api",
			"gateway": "models.dev"
		},
		"privatemode-ai": {
		...
		"openreason": {
			...
			"apiKeyEnvVar": "OPENREASON_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "OpenReason",
			"models": [
				"deepseek-ai/deepseek-v4-flash-0731",
			...
			"docUrl": "https://openreason.app/docs",
			"gateway": "models.dev"
		},
		"merge-gateway": {
		...
		"opencode": {
			...
			"modelOverrides": {
				...
				"muse-spark-1.3": { "npm": "@ai-sdk/openai" },
				"muse-spark-1.3-contributor-free": { "npm": "@ai-sdk/openai" },
				...
				"claude-fable-5-1": { "npm": "@ai-sdk/anthropic" },
				...
				"gemini-3.8-flash": { "npm": "@ai-sdk/google" },
		...
		"iteracompute": {
			...
			"apiKeyEnvVar": "ITERACOMPUTE_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "IteraCompute",
			"models": ["iteracompute/ornith-1.5-35b-a3b", "iteracompute/qwen3.8-27b"],
			"docUrl": "https://iteracompute.com/docs.html",
			"gateway": "models.dev"
		},
		"model-oracle-ai": {
		...
		"melious": {
			...
			"docUrl": "https://melious.ai/docs/reference/models",
			"gateway": "models.dev"
		},
		"moonshotai": {
		...
		"volcengine-coding-plan": {
			...
			"apiKeyEnvVar": "ARK_CODING_PLAN_API_KEY",
			"apiKeyHeader": "Authorization",
			...
			"docUrl": "https://www.volcengine.com/docs/82379/1928261",
			"gateway": "models.dev"
		},
		"302ai": {
		...
		"wallaby": {
			...
			"apiKeyEnvVar": "WALLABY_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "Wallaby",
			"models": ["moonshotai/kimi-k3"],
			"docUrl": "https://wallabytoken.com/docs",
			"gateway": "models.dev"
		},
		"hpc-ai": {
		...
		"nan": {
			...
			"docUrl": "https://nan.builders/docs/models",
			"gateway": "models.dev"
		},
		"perplexity": {
			"apiKeyEnvVar": "PERPLEXITY_API_KEY",
		...
		"opencode-go": {
			...
			"modelOverrides": {
				...
				"grok-4.5": { "npm": "@ai-sdk/openai" },
				"gpt-5.6-luna": { "npm": "@ai-sdk/openai" },
				"muse-spark-1.3-contributor": { "npm": "@ai-sdk/openai" },
				"qwen3.8-flash": { "npm": "@ai-sdk/anthropic" },
				"grok-4.6": { "npm": "@ai-sdk/openai" }
			},
			"deprecatedModels": [
				"glm-5",
		...
		"vispark": {
			...
			"apiKeyEnvVar": "VISPARK_LAB_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "Vispark",
			"models": [
			...
			"docUrl": "https://lab.vispark.in/#vision",
			"gateway": "models.dev"
		},
		"neosmith": {
			"url": "https://router.neosmith.ai/v1",
			"apiKeyEnvVar": "NEOSMITH_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "NeoSmith",
			"models": [
	...
	models: {
		...
		"infer": ["infer/gpt-5.6-sol:official", "infer/gpt-6-astra:official"],
		"stepfun-ai": [
			"step-1-32k",
			"step-2-16k",
			"step-3.5-flash",
		...
		"iteracompute": ["iteracompute/ornith-1.5-35b-a3b", "iteracompute/qwen3.8-27b"],
		"model-oracle-ai": [
			"auto",
			"claude-fable-5",
			"claude-haiku-4.5",
		...
		"tencent-token-plan": ["hy3", "hy4-preview"],
		"vispark": [
			"vispark/vision-large",
			"vispark/vision-medium",
			"vispark/vision-small"
...
const capabilityOverrides = {
	structuredOutput: { "deepseek/deepseek-v4-pro": false },
	temperature: { "aws-bedrock/grok-4.6": false }
};
/**
...
*/
const PROVIDER_ALIASES = { "amazon-bedrock": "aws-bedrock" };
...
const BEDROCK_VENDOR_BY_PREFIX = [
	[/^claude/, "anthropic"],
	[/^grok/, "xai"],
	[/^llama/, "meta"],
	[/^(nova|titan)/, "amazon"],
...
*/
function resolveBedrockVendorModel(modelId) {
	...
	if (segmentMatch) return {
		vendor: segmentMatch[1],
		shortId: segmentMatch[2]
	};
	for (const [pattern, vendor] of BEDROCK_VENDOR_BY_PREFIX) if (pattern.test(withoutRegion)) return {
		vendor,
		shortId: withoutRegion
	};
	return {
		vendor: null,
		shortId: withoutRegion
...
function modelSupportsCapability(modelRouterId, dimension) {
	...
	const override = capabilityOverrides[dimension]?.[canonicalRouterId] ?? capabilityOverrides[dimension]?.[modelRouterId];
	...
	if (provider === "aws-bedrock" && directSupport === void 0 && bedrockVendor) {
		const vendorSupport = getProviderCapabilitySupport(bedrockVendor, modelId, dimension, useDynamicLoading);
		if (vendorSupport !== void 0) return vendorSupport;
	}
...
var GatewayRegistry = class GatewayRegistry {
	...
	*/
	async syncGateways(forceRefresh = false, writeToSrc = false) {
		...
		try {
			const { ModelsDevGateway } = await Promise.resolve().then(() => require("./models-dev-DwimeuYR.cjs")).then((n) => n.models_dev_exports);
			const { NetlifyGateway } = await Promise.resolve().then(() => require("./netlify-jtLUgvwg.cjs")).then((n) => n.netlify_exports);
			const { MastraGateway } = await Promise.resolve().then(() => mastra_exports);
			const { fetchProvidersFromGateways, writeRegistryFiles } = await Promise.resolve().then(() => require("./registry-generator-BapL8GCt.cjs"));
...
//# sourceMappingURL=provider-registry-BYH6y4zy.cjs.map