 ...
 */
export declare class TaskSignalProvider extends SignalProvider<'task-signals'> {
    #private;
    readonly id = "task-signals";
    getInputProcessors(): InputProcessorOrWorkflow[];
    getTools(): {
        task_write: import("../tools").Tool<{
            tasks: {
                id?: string | undefined;
                content: string;
        ...
        task_update: import("../tools").Tool<{
            id: string;
            content?: string | undefined;
            status?: "completed" | "in_progress" | "pending" | undefined;
            ...
            isError: boolean;
        }, unknown, unknown, import("../tools").ToolExecutionContext<unknown, unknown, unknown>, "task_update", unknown>;
        task_complete: import("../tools").Tool<{
            id: string;
        }, {
            content: string;
            tasks: {
            ...
            isError: boolean;
        }, unknown, unknown, import("../tools").ToolExecutionContext<unknown, unknown, unknown>, "task_complete", unknown>;
        task_check: import("../tools").Tool<Record<string, never>, {
            content: string;
            tasks: {
                content: string;
                status: "completed" | "in_progress" | "pending";
...
//# sourceMappingURL=task-signal-provider.d.ts.map