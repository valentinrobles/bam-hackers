 ...
 * ```
 */
export type AgentSkillsInput<TRequestContext extends Record<string, any> | unknown = unknown> = SkillInput[] | AgentSkillsResolver<TRequestContext>;
/**
 * The dynamic half of {@link AgentSkillsInput} — a function resolving skills per request.
 */
export type AgentSkillsResolver<TRequestContext extends Record<string, any> | unknown = unknown> = (context: AgentSkillsContext<TRequestContext>) => SkillInput[] | Promise<SkillInput[]>;
