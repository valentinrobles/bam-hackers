...
const require_base = require("./base-BBpaorAZ.cjs");
const require_error = require("./error-B-e62x-A.cjs");
const require_utils = require("./utils-C-Fr0ZIA.cjs");
const require_message_list = require("./message-list-BOqnUw5W.cjs");
const require_constants = require("./constants-BV7TjhE-.cjs");
const require_filesystem_versioned = require("./filesystem-versioned-BqBL3KaM.cjs");
const require_base$1 = require("./base-BXH8ef94.cjs");
const require_features_index = require("./features/index.cjs");
const require_source = require("./source-CVacgqJ6.cjs");
const require_inmemory = require("./inmemory-Bi3z2Ulh.cjs");
const require_filesystem = require("./filesystem-CedfstZP.cjs");
const require_filesystem$1 = require("./filesystem-CbG7KeS6.cjs");
const require_storage = require("./storage-DYAE1FYc.cjs");
const require_filesystem$2 = require("./filesystem-BU56P2ag.cjs");
const require_filesystem$3 = require("./filesystem-Zv9tVw4K.cjs");
const require_filesystem$4 = require("./filesystem-CbqpIA3f.cjs");
const require_filesystem$5 = require("./filesystem-BYPUsNge.cjs");
...
var ObservabilityStorage = class ObservabilityStorage extends require_base$1.StorageDomain {
	...
	*/
	assertUnscopedBatchDeleteTraces(args) {
		if (args.organizationId !== void 0 || args.resourceId !== void 0) throw new require_error.MastraError({
...
var ObservabilityInMemory = class extends ObservabilityStorage {
	...
	*iterateObservabilityContextRecords() {
	...
	async updateFeedbackReviewStatus(args) {
		...
		if (!feedback) throw new require_error.MastraError({
...
const literalStringSchema = zod_v4.z.string().refine((value) => hasMaxUtf8Bytes(value, TRACE_QUERY_MAX_STRING_BYTES), "String literal is too large");
const timestampLiteralSchema = zod_v4.z.string().datetime({ offset: true });
const predicatePathSchema = zod_v4.z.string().min(1).refine((value) => hasMaxUtf8Bytes(value, 128), "Predicate path is too large");
...
const pathRefSchema = zod_v4.z.object({ path: predicatePathSchema }).strict();
const literalRefSchema = zod_v4.z.object({ literal: literalSchema }).strict();
const pathOrLiteralSchema = zod_v4.z.union([pathRefSchema, literalRefSchema]);
const traceQueryScalarPredicateSchema = zod_v4.z.lazy(() => zod_v4.z.union([
	zod_v4.z.object({
		op: zod_v4.z.enum([
			"eq",
			"ne",
	...
	zod_v4.z.object({
		...
		set: zod_v4.z.array(literalSchema).min(1).max(100)
	}).strict(),
	zod_v4.z.object({
	...
	zod_v4.z.object({
		...
		args: zod_v4.z.array(traceQueryScalarPredicateSchema).min(1)
	}).strict(),
	zod_v4.z.object({
...
const traceQueryPredicateSchema = zod_v4.z.lazy(() => zod_v4.z.union([
	zod_v4.z.object({
		op: zod_v4.z.enum([
			"eq",
			"ne",
	...
	zod_v4.z.object({
		op: zod_v4.z.enum(["and", "or"]),
		args: zod_v4.z.array(traceQueryPredicateSchema).min(1)
	}).strict(),
	zod_v4.z.object({
		op: zod_v4.z.literal("not"),
		arg: traceQueryPredicateSchema
	}).strict(),
	zod_v4.z.object({ spans: zod_v4.z.union([zod_v4.z.object({ some: traceQueryScalarPredicateSchema }).strict(), zod_v4.z.object({ none: traceQueryScalarPredicateSchema }).strict()]) }).strict(),
	zod_v4.z.object({ scores: zod_v4.z.union([zod_v4.z.object({ some: traceQueryScalarPredicateSchema }).strict(), zod_v4.z.object({ none: traceQueryScalarPredicateSchema }).strict()]) }).strict(),
	zod_v4.z.object({ feedback: zod_v4.z.union([zod_v4.z.object({ some: traceQueryScalarPredicateSchema }).strict(), zod_v4.z.object({ none: traceQueryScalarPredicateSchema }).strict()]) }).strict()
]));
const traceQueryTimeRangeSchema = zod_v4.z.object({
	from: zod_v4.z.string().datetime({ offset: true }),
	to: zod_v4.z.string().datetime({ offset: true })
}).strict();
const traceSelectionSchema = zod_v4.z.object({
	timeRange: traceQueryTimeRangeSchema,
	where: traceQueryPredicateSchema.optional()
}).strict();
const threadPredicateSchema = zod_v4.z.lazy(() => zod_v4.z.union([
	zod_v4.z.object({
		op: zod_v4.z.enum(["and", "or"]),
		args: zod_v4.z.array(threadPredicateSchema).min(1)
	}).strict(),
	zod_v4.z.object({
		op: zod_v4.z.literal("not"),
		arg: threadPredicateSchema
	}).strict(),
	zod_v4.z.object({ traces: zod_v4.z.union([zod_v4.z.object({ some: traceQueryPredicateSchema }).strict(), zod_v4.z.object({ none: traceQueryPredicateSchema }).strict()]) }).strict()
]));
const pageSchema = zod_v4.z.object({
	limit: zod_v4.z.number().int().min(1).max(1e3).default(100),
	after: zod_v4.z.string().min(1).nullable().optional()
}).strict().default({ limit: 100 });
const traceQueryRequestObjectSchema = zod_v4.z.object({
	timeRange: traceQueryTimeRangeSchema,
	where: traceQueryPredicateSchema.optional(),
	group: zod_v4.z.object({ by: zod_v4.z.tuple([zod_v4.z.literal("threadId")]) }).strict().optional(),
	orderBy: zod_v4.z.array(zod_v4.z.object({
		field: zod_v4.z.enum(["startedAt", "endedAt"]),
		direction: zod_v4.z.enum(["asc", "desc"])
	}).strict()).length(1).optional(),
	page: pageSchema
}).strict();
const traceQueryRequestSchema = zod_v4.z.preprocess((input, context) => {
...
const queryThreadsInputObjectSchema = zod_v4.z.object({
	traces: traceSelectionSchema,
	where: threadPredicateSchema.optional(),
	page: pageSchema
}).strict();
const queryThreadsInputSchema = zod_v4.z.preprocess((input, context) => {
...
const traceQueryTraceSchema = zod_v4.z.object({
	traceId: zod_v4.z.string(),
	rootSpanId: zod_v4.z.string(),
	threadId: zod_v4.z.string().nullable(),
	resourceId: zod_v4.z.string().nullable(),
	startedAt: zod_v4.z.string().datetime({ offset: true }),
	endedAt: zod_v4.z.string().datetime({ offset: true }),
	entityName: zod_v4.z.string().nullable(),
	entityType: zod_v4.z.string().nullable(),
	environment: zod_v4.z.string().nullable(),
	status: zod_v4.z.enum(["success", "error"])
}).strict();
const responsePageSchema = zod_v4.z.object({ next: zod_v4.z.string().nullable() }).strict();
const traceQueryTraceResponseSchema = zod_v4.z.object({
	traces: zod_v4.z.array(traceQueryTraceSchema),
	page: responsePageSchema
}).strict();
const traceQueryGroupResponseSchema = zod_v4.z.object({
	groups: zod_v4.z.array(zod_v4.z.object({ threadId: zod_v4.z.string() }).strict()),
	page: responsePageSchema
}).strict();
const traceQueryResponseSchema = zod_v4.z.union([traceQueryTraceResponseSchema, traceQueryGroupResponseSchema]);
const threadIdentitySchema = zod_v4.z.object({ threadId: zod_v4.z.string() }).strict();
const queryThreadsResultSchema = zod_v4.z.object({
	threads: zod_v4.z.array(threadIdentitySchema),
	page: responsePageSchema
}).strict();
...
const cursorEnvelopeSchema = zod_v4.z.object({
	version: zod_v4.z.literal(1),
	binding: zod_v4.z.string().length(64),
	values: zod_v4.z.discriminatedUnion("result", [
		zod_v4.z.object({
			result: zod_v4.z.literal("traces"),
			sortValue: zod_v4.z.string().datetime({ offset: true }),
			traceId: zod_v4.z.string().min(1)
		}).strict(),
		zod_v4.z.object({
			result: zod_v4.z.literal("groups"),
			threadId: zod_v4.z.string().min(1)
		}).strict(),
		zod_v4.z.object({
			result: zod_v4.z.literal("threads"),
			threadId: zod_v4.z.string().min(1)
		}).strict()
	])
}).strict();
...
function digestBinding(value) {
	return (0, crypto$1.createHash)("sha256").update(stableStringify(value)).digest("hex");
}
...
var DatasetsStorage = class extends require_base$1.StorageDomain {
	...
	*/
	async updateItem(args) {
		...
		if (existing?.datasetId === args.datasetId && existing.metadata?.__purged === true) throw new require_error.MastraError({
...
var MemoryStorage = class MemoryStorage extends require_base$1.StorageDomain {
	/**
...
Object.defineProperty(exports, "MAX_KNOWLEDGE_NODE_DESCRIPTION_LENGTH", {
	enumerable: true,
	get: function() {
		return MAX_KNOWLEDGE_NODE_DESCRIPTION_LENGTH;
	}
});
...
Object.defineProperty(exports, "TRACE_QUERY_DEFAULT_TIMEOUT_MS", {
	enumerable: true,
	get: function() {
		return TRACE_QUERY_DEFAULT_TIMEOUT_MS;
	}
});
Object.defineProperty(exports, "TRACE_QUERY_MAX_DEPTH", {
	enumerable: true,
	get: function() {
		return TRACE_QUERY_MAX_DEPTH;
	}
});
Object.defineProperty(exports, "TRACE_QUERY_MAX_LITERAL_UNITS", {
	enumerable: true,
	get: function() {
		return TRACE_QUERY_MAX_LITERAL_UNITS;
	}
});
Object.defineProperty(exports, "TRACE_QUERY_MAX_NODES", {
	enumerable: true,
	get: function() {
		return TRACE_QUERY_MAX_NODES;
	}
});
Object.defineProperty(exports, "TRACE_QUERY_MAX_PATH_BYTES", {
	enumerable: true,
	get: function() {
		return TRACE_QUERY_MAX_PATH_BYTES;
	}
});
Object.defineProperty(exports, "TRACE_QUERY_MAX_RELATED_CLAUSES", {
	enumerable: true,
	get: function() {
		return TRACE_QUERY_MAX_RELATED_CLAUSES;
	}
});
Object.defineProperty(exports, "TRACE_QUERY_MAX_SET_VALUES", {
	enumerable: true,
	get: function() {
		return TRACE_QUERY_MAX_SET_VALUES;
	}
});
Object.defineProperty(exports, "TRACE_QUERY_MAX_STRING_BYTES", {
	enumerable: true,
	get: function() {
		return TRACE_QUERY_MAX_STRING_BYTES;
	}
});
Object.defineProperty(exports, "TRACE_QUERY_MAX_TIMEOUT_MS", {
	enumerable: true,
	get: function() {
		return TRACE_QUERY_MAX_TIMEOUT_MS;
	}
});
...
Object.defineProperty(exports, "TraceQueryCursorError", {
	enumerable: true,
	get: function() {
		return TraceQueryCursorError;
	}
});
Object.defineProperty(exports, "TraceQueryExecutionError", {
	enumerable: true,
	get: function() {
		return TraceQueryExecutionError;
	}
});
Object.defineProperty(exports, "TraceQueryValidationError", {
	enumerable: true,
	get: function() {
		return TraceQueryValidationError;
	}
});
...
Object.defineProperty(exports, "assertKnowledgeDescriptionWithinBound", {
	enumerable: true,
	get: function() {
		return assertKnowledgeDescriptionWithinBound;
	}
});
...
Object.defineProperty(exports, "compareTraceQueryStrings", {
	enumerable: true,
	get: function() {
		return compareTraceQueryStrings;
	}
});
...
Object.defineProperty(exports, "encodeTraceQueryCursor", {
	enumerable: true,
	get: function() {
		return encodeTraceQueryCursor;
	}
});
...
Object.defineProperty(exports, "formatTraceQuerySchemaIssues", {
	enumerable: true,
	get: function() {
		return formatTraceQuerySchemaIssues;
	}
});
...
Object.defineProperty(exports, "parseQueryThreadsInput", {
	enumerable: true,
	get: function() {
		return parseQueryThreadsInput;
	}
});
Object.defineProperty(exports, "parseTraceQueryRequest", {
	enumerable: true,
	get: function() {
		return parseTraceQueryRequest;
	}
});
Object.defineProperty(exports, "planThreadQuery", {
	enumerable: true,
	get: function() {
		return planThreadQuery;
	}
});
Object.defineProperty(exports, "planTraceQuery", {
	enumerable: true,
	get: function() {
		return planTraceQuery;
	}
});
Object.defineProperty(exports, "queryThreadsInputSchema", {
	enumerable: true,
	get: function() {
		return queryThreadsInputSchema;
	}
});
Object.defineProperty(exports, "queryThreadsResultSchema", {
	enumerable: true,
	get: function() {
		return queryThreadsResultSchema;
	}
});
...
Object.defineProperty(exports, "resolveTraceQueryTimeoutMs", {
	enumerable: true,
	get: function() {
		return resolveTraceQueryTimeoutMs;
	}
});
...
Object.defineProperty(exports, "threadIdentitySchema", {
	enumerable: true,
	get: function() {
		return threadIdentitySchema;
	}
});
Object.defineProperty(exports, "threadPredicateSchema", {
	enumerable: true,
	get: function() {
		return threadPredicateSchema;
	}
});
...
Object.defineProperty(exports, "traceQueryGroupResponseSchema", {
	enumerable: true,
	get: function() {
		return traceQueryGroupResponseSchema;
	}
});
Object.defineProperty(exports, "traceQueryPredicateSchema", {
	enumerable: true,
	get: function() {
		return traceQueryPredicateSchema;
	}
});
Object.defineProperty(exports, "traceQueryRequestSchema", {
	enumerable: true,
	get: function() {
		return traceQueryRequestSchema;
	}
});
Object.defineProperty(exports, "traceQueryResponseSchema", {
	enumerable: true,
	get: function() {
		return traceQueryResponseSchema;
	}
});
Object.defineProperty(exports, "traceQueryScalarPredicateSchema", {
	enumerable: true,
	get: function() {
		return traceQueryScalarPredicateSchema;
	}
});
Object.defineProperty(exports, "traceQueryTimeRangeSchema", {
	enumerable: true,
	get: function() {
		return traceQueryTimeRangeSchema;
	}
});
Object.defineProperty(exports, "traceQueryTraceResponseSchema", {
	enumerable: true,
	get: function() {
		return traceQueryTraceResponseSchema;
	}
});
Object.defineProperty(exports, "traceQueryTraceSchema", {
	enumerable: true,
	get: function() {
		return traceQueryTraceSchema;
	}
});
Object.defineProperty(exports, "traceSelectionSchema", {
	enumerable: true,
	get: function() {
		return traceSelectionSchema;
	}
});
...
//# sourceMappingURL=storage-B9R3bmN-.cjs.map