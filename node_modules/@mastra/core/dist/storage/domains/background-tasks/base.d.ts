import type { BackgroundTask, BackgroundTaskStatus, TaskFilter, TaskListResult, UpdateBackgroundTask } from '../../../background-tasks/types.js';
...
export declare abstract class BackgroundTasksStorage extends StorageDomain {
     ...
     */
    abstract updateTask(taskId: string, update: UpdateBackgroundTask, options?: {
