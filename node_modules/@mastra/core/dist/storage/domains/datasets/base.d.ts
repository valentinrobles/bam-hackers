import type { DatasetRecord, DatasetItem, DatasetItemRow, DatasetVersion, CreateDatasetInput, UpdateDatasetInput, AddDatasetItemInput, UpdateDatasetItemInput, DeleteDatasetItemInput, PurgeDatasetItemInput, ListDatasetsInput, ListDatasetsOutput, ListDatasetItemsInput, ListDatasetItemsOutput, ListDatasetVersionsInput, ListDatasetVersionsOutput, BatchInsertItemsInput, BatchDeleteItemsInput, DatasetTenancyFilters } from '../../types.js';
import { StorageDomain } from '../base.js';
import type { DatasetItemBatchPlan } from './identity.js';
/**
...
export declare abstract class DatasetsStorage extends StorageDomain {
     ...
     */
    protected resolveExistingDataset(existing: DatasetRecord, input: CreateDatasetInput & {
        id: string;
    }): DatasetRecord;
     ...
     */
    deleteItem(args: DeleteDatasetItemInput): Promise<void>;
     ...
     */
    purgeItem(args: PurgeDatasetItemInput): Promise<void>;
    ...
    protected planDatasetItemBatch(items: BatchInsertItemsInput['items'], historyRows: DatasetItemRow[], createId: () => string): DatasetItemBatchPlan;
