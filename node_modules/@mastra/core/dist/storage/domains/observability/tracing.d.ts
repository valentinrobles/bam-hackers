...
import type { SpanInput, SpanOutput, SpanTypeMap } from '../../../observability/types/index.js';
 ...
 * guard.
 */
export type TypedSpanRecord<TType extends SpanType> = TType extends SpanType ? Omit<StoredSpanRecord, 'spanType' | 'attributes' | 'input' | 'output'> & {
    spanType: TType;
 ...
 */
export type SpanRecord<TType extends SpanType = SpanType> = SpanType extends TType ? StoredSpanRecord : TypedSpanRecord<TType>;
/**
...
export declare const BATCH_DELETE_TRACES_MAX_IDS = 1000;
/**
...
export declare const batchDeleteTracesResponseSchema: z.ZodObject<{
