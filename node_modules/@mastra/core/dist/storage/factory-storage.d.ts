 ...
 */
import type { MastraCompositeStore } from './base.js';
import { StorageDomain } from './domains/base.js';
 ...
 */
export type CollectionWhere = Record<string, CollectionValue | {
    in: CollectionValue[];
}>;
/**
 ...
 */
export declare class UniqueViolationError extends Error {
...
export interface FactoryStorageOps {
    ...
    findMany<T extends Record<string, unknown>>(collection: string, where: CollectionWhere, opts?: CollectionListOptions): Promise<T[]>;
     ...
     */
    updateAtomic<T extends Record<string, unknown>>(collection: string, where: CollectionWhere, fn: (row: T) => Partial<T> | null | Promise<Partial<T> | null>): Promise<T | null>;
}
/**
 ...
 */
export declare abstract class FactoryStorageDomain extends StorageDomain {
    #private;
 ...
 */
export declare abstract class FactoryStorage {
    #private;
    /**
    ...
    ensureDomainReady(name: string): Promise<void>;
    /**
     ...
     */
    abstract withTransaction<T>(fn: (ops: FactoryStorageOps) => Promise<T>, options?: {
