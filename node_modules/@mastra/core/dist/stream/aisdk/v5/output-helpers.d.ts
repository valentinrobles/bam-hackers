import type { StepResult, ToolSet, StaticToolCall, StaticToolResult, DynamicToolCall, DynamicToolResult } from '../../../_types/@internal_ai-sdk-v5/dist/index.d.ts';
...
export declare class DefaultStepResult<TOOLS extends ToolSet> implements StepResult<TOOLS> {
    ...
    get text(): string;
    get reasoning(): import("../../../_types/@internal_ai-sdk-v5/dist/index.d.ts").ReasoningOutput[];
    get reasoningText(): string | undefined;
    get files(): import("../../../_types/@internal_ai-sdk-v5/dist/index.d.ts").GeneratedFile[];
