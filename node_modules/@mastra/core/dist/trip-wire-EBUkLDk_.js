...
import { a as createObservabilityContext, o as resolveObservabilityContext } from "./observability-DlWHQwp0.js";
import { o as getRootExportSpan, p as EntityType, t as executeWithContext } from "./utils-C64E0GKG.js";
import "./tracing-D2hyX6p5.js";
import { s as RequestContext } from "./request-context-DUS79r4j.js";
import { n as attachModelStreamTransport, r as readModelStreamTransport } from "./types-tp6wFHm5.js";
import { isStandardSchemaWithJSON, standardSchemaToJSONSchema, toStandardSchema } from "./schema/index.js";
import { n as createSignal } from "./signals-DmocOMcE.js";
import { a as coreContentToString, n as MessageList, o as messagesAreEqual, t as convertMessages } from "./message-list-DCUwKHqe.js";
import { a as isDeepEqualData, d as JSONParseError, f as TypeValidationError, s as parsePartialJson, t as NoObjectGeneratedError, u as APICallError } from "./dist-Ou20DOGE.js";
import { c as resolveStateSignalHistory, i as parseMemoryRequestContext, o as applyStateSignal, s as getStateSignalsMetadata, t as isSignalChunkExcluded } from "./signal-exclusions-FOFJ_pxS.js";
import { i as resolveModelConfig } from "./llm-Oy59omd7.js";
...
function getErrorCandidates(error) {
	...
	if (APICallError.isInstance(error) && typeof error.responseBody === "string") candidates.push(error.responseBody);
...
function matchesRule(error, rule) {
	...
	if (APICallError.isInstance(error)) return getErrorCandidates(error).some(matches);
	...
	*/
	...
	constructor({ model: _model, stream, messageList, options, messageId, initialState }) {
		...
		if (processorRunner && options.isLLMExecutionStep) {
			...
			processedStream = stream.pipeThrough(new TransformStream({
				async transform(chunk, controller) {
					...
					case "finish":
						...
						try {
							if (self.processorRunner && !self.#options.isLLMExecutionStep) {
								...
								self.messageList = await self.processorRunner.runOutputProcessors(self.messageList, resolveObservabilityContext(options), self.#options.requestContext, 0, outputResultWriter, outputResult);
...
//#endregion
export { supportedLanguageModelSpecifications as A, createProcessorSendSignal as C, isMaybeAnthropicWithoutAssistantPrefill as D, cerebrasStripReasoningContent as E, tryStreamWithJsonFallback as M, DelayedPromise as N, isSupportedLanguageModel as O, isProcessorWorkflow as P, toProcessorSpanPhase as S, anthropicToolIdFormat as T, summarizeProcessorResultForSpan as _, escapeUnescapedControlCharsInJsonStrings as a, resolveProcessorSpanAttributes as b, safeClose as c, ProcessorRunner as d, ProcessorState as f, summarizeProcessorModelForSpan as g, summarizeActiveToolsForSpan as h, createDestructurableOutput as i, tryGenerateWithJsonFallback as j, resolveThreadIdFromArgs as k, safeEnqueue as l, REPROCESS_PART_KEY as m, getModelOutputForTripwire as n, getResponseFormat as o, runner_exports as p, MastraModelOutput as r, MastraModelInput as s, TripWire as t, OUTPUT_STREAM_HOOK_DURATION_KEY_PREFIX as u, summarizeProcessorToolsForSpan as v, ProviderHistoryCompat as w, resolveProcessorSpanName as x, summarizeToolChoiceForSpan as y };

//# sourceMappingURL=trip-wire-EBUkLDk_.js.map