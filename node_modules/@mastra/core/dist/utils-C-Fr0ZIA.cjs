...
const createFeedbackRecordSchema = zod_v4.z.object(createFeedbackRecordObjectSchema.shape).describe("Feedback record accepted on creation");
/** Schema for createFeedback operation arguments */
const createFeedbackArgsSchema = zod_v4.z.object({ feedback: zod_v4.z.preprocess(normalizeLegacyFeedbackActor, createFeedbackRecordObjectSchema) }).describe("Arguments for creating feedback");
...
const batchCreateFeedbackArgsSchema = zod_v4.z.object({ feedbacks: zod_v4.z.array(zod_v4.z.preprocess(normalizeLegacyFeedbackActor, createFeedbackRecordObjectSchema)) }).describe("Arguments for batch recording feedback");
/** Schema for updating a feedback record's review status */
const updateFeedbackReviewStatusArgsSchema = zod_v4.z.object({
...
Object.defineProperty(exports, "deleteFeedbackArgsSchema", {
	enumerable: true,
	get: function() {
		return deleteFeedbackArgsSchema;
	}
});
Object.defineProperty(exports, "deleteFeedbackResponseSchema", {
	enumerable: true,
	get: function() {
		return deleteFeedbackResponseSchema;
	}
});
Object.defineProperty(exports, "deleteScoresArgsSchema", {
	enumerable: true,
	get: function() {
		return deleteScoresArgsSchema;
	}
});
Object.defineProperty(exports, "deleteScoresResponseSchema", {
	enumerable: true,
	get: function() {
		return deleteScoresResponseSchema;
	}
});
...
Object.defineProperty(exports, "feedbackReviewStatusSchema", {
	enumerable: true,
	get: function() {
		return feedbackReviewStatusSchema;
	}
});
...
Object.defineProperty(exports, "resolveExportedSpanId", {
	enumerable: true,
	get: function() {
		return resolveExportedSpanId;
	}
});
...
Object.defineProperty(exports, "updateFeedbackReviewStatusArgsSchema", {
	enumerable: true,
	get: function() {
		return updateFeedbackReviewStatusArgsSchema;
	}
});
...
//# sourceMappingURL=utils-C-Fr0ZIA.cjs.map