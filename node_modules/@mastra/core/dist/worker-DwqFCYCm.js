...
import { n as StepExecutor, r as computeScheduleDefinitionHash, s as getStepEntry, t as WorkflowEventProcessor } from "./workflow-event-processor-BSZt3kfu.js";
import { t as resolveAgentById } from "./resolve-agent-LNSk8IsI.js";
import { t as Scheduler } from "./scheduler-3bLZ3ugK.js";
import { r as MastraWorker, t as PullTransport } from "./pull-transport-D6pSbsAj.js";
...
var SchedulerWorker = class extends MastraWorker {
	...
	async init(deps) {
		...
		const isTargetCurrent = mastra ? (target) => {
			if (target.type !== "workflow" || !target.definitionHash) return true;
			try {
				const localHash = computeScheduleDefinitionHash(mastra.getWorkflowById(target.workflowId).serializedStepGraph);
		...
		const canExecuteLocally = mastra ? () => mastra.__hasLocalWorkflowExecution() : void 0;
...
//# sourceMappingURL=worker-DwqFCYCm.js.map