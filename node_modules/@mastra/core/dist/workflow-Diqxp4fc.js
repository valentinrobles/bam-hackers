...
import { c as BACKGROUND_TASK_WORKFLOW_ID } from "./background-tasks-Dt8uUqZI.js";
import { bn as createWorkflow, jn as createStep } from "./agent-Dk0N0Nlg.js";
import { z } from "zod";
	...
	const runAttemptStep = createStep({
		...
		execute: async ({ inputData, abortSignal: workflowAbortSignal, suspend, resumeData, suspendData }) => {
			...
			try {
				...
				if (resumeData !== void 0 && !args.suspendedToolRunId && typeof suspendedToolRunId === "string") args.suspendedToolRunId = suspendedToolRunId;
				...
				if (pendingSuspend) {
					...
					const agentRunId = opts?.isAgentSuspend && typeof opts.runId === "string" ? opts.runId : void 0;
					return suspend(!agentRunId ? pendingSuspend.data : pendingSuspend.data && typeof pendingSuspend.data === "object" ? {
						...pendingSuspend.data,
						suspendedToolRunId: agentRunId
					} : { suspendedToolRunId: agentRunId }, opts);
				}
				return {
					taskId,
					outcome: "success",
...
//# sourceMappingURL=workflow-Diqxp4fc.js.map