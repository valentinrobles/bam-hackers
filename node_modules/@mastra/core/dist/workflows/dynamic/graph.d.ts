 ...
 */
import type { SerializedSingleStepEntry } from '../types.js';
 ...
 */
export declare function forEachSingleStepEntry(entries: readonly ValidatableStepFlowEntry[], visit: (entry: SerializedSingleStepEntry) => void): void;
/**
 ...
 */
export declare function collectNestedWorkflowIds(graph: readonly ValidatableStepFlowEntry[]): Set<string>;
/**
