...
import type { ObservabilityContext, Span, TracingOptions, TracingPolicy } from '../observability/index.js';
import { SpanType } from '../observability/index.js';
import type { Processor, ProcessorStepExecutor } from '../processors/index.js';
import { ProcessorStepOutputSchema, ProcessorStepInputSchema } from '../processors/step-schema.js';
import type { ProcessorStepInput, ProcessorStepOutput } from '../processors/step-schema.js';
...
export declare function createStepFromProcessor<TProcessorId extends string>(processor: Processor<TProcessorId>): Step<`processor:${TProcessorId}`, unknown, z.infer<typeof ProcessorStepInputSchema>, z.infer<typeof ProcessorStepOutputSchema>, unknown, unknown, DefaultEngineType> & {
...
export declare class Workflow<TEngineType = DefaultEngineType, TSteps extends Step<string, any, any, any, any, any, TEngineType, any>[] = Step<string, unknown, unknown, unknown, unknown, unknown, TEngineType>[], TWorkflowId extends string = string, TState = unknown, TInput = unknown, TOutput = unknown, TPrevSchema = TInput, TRequestContext extends Record<string, any> | unknown = unknown> extends MastraBase implements Step<TWorkflowId, TState, TInput, TOutput | undefined, any, any, DefaultEngineType, TRequestContext> {
     ...
     * @returns The workflow instance for chaining
     */
    sleep(duration: number | ExecuteFunction<TState, TPrevSchema, number, any, any, TEngineType>, options?: StepFlowEntryOptions): Workflow<TEngineType, TSteps, TWorkflowId, TState, TInput, TOutput, TPrevSchema, TRequestContext>;
    /**
     ...
     * @returns The workflow instance for chaining
     */
    sleepUntil(date: Date | ExecuteFunction<TState, TPrevSchema, Date, any, any, TEngineType>, options?: StepFlowEntryOptions): Workflow<TEngineType, TSteps, TWorkflowId, TState, TInput, TOutput, TPrevSchema, TRequestContext>;
    /**
    ...
    }, options?: StepFlowEntryOptions): Workflow<TEngineType, TSteps, TWorkflowId, TState, TInput, TOutput, { [K in keyof StepsRecord<TParallelSteps>]: InferStandardSchemaOutput<StepsRecord<TParallelSteps>[K]['outputSchema']>; }, TRequestContext>;
    ...
    ]>>(steps: TBranchSteps, options?: StepFlowEntryOptions): Workflow<TEngineType, TSteps, TWorkflowId, TState, TInput, TOutput, { [K in keyof StepsRecord<{ [K_1 in keyof TBranchSteps]: TBranchSteps[K_1][1]; }[number][]>]?: InferStandardSchemaOutput<StepsRecord<{ [K_1 in keyof TBranchSteps]: TBranchSteps[K_1][1]; }[number][]>[K]['outputSchema']>; }, TRequestContext>;
    dowhile<TStepState, TStepInputSchema extends TPrevSchema, TStepId extends string, TSchemaOut, TStepRC>(step: Step<TStepId, SubsetOf<TStepState, TState>, TStepInputSchema, TSchemaOut, any, any, TEngineType, unknown extends TStepRC ? unknown : TRequestContext>, condition: LoopConditionFunction<TState, TSchemaOut, any, any, any, TEngineType> | {
        predicate: Predicate;
    }, options?: StepFlowEntryOptions): Workflow<TEngineType, TSteps, TWorkflowId, TState, TInput, TOutput, TSchemaOut, TRequestContext>;
    dountil<TStepState, TStepInputSchema extends TPrevSchema, TStepId extends string, TSchemaOut, TStepRC>(step: Step<TStepId, SubsetOf<TStepState, TState>, TStepInputSchema, TSchemaOut, any, any, TEngineType, unknown extends TStepRC ? unknown : TRequestContext>, condition: LoopConditionFunction<TState, TSchemaOut, any, any, any, TEngineType> | {
        predicate: Predicate;
    }, options?: StepFlowEntryOptions): Workflow<TEngineType, TSteps, TWorkflowId, TState, TInput, TOutput, TSchemaOut, TRequestContext>;
    foreach<TPrevIsArray extends (TPrevSchema extends any[] ? true : false), TStepState, TStepInputSchema extends (TPrevSchema extends (infer TElement)[] ? TElement : never), TStepId extends string, TSchemaOut, TStepRC>(step: TPrevIsArray extends true ? Step<TStepId, SubsetOf<TStepState, TState>, TStepInputSchema, TSchemaOut, any, any, TEngineType, unknown extends TStepRC ? unknown : TRequestContext> : 'Previous step must return an array type', opts?: Partial<ForeachOptions> & StepFlowEntryOptions): Workflow<TEngineType, TSteps, TWorkflowId, TState, TInput, TOutput, TSchemaOut[], TRequestContext>;
    /**
