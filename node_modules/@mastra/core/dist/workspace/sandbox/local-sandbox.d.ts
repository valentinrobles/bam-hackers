 ...
 */
export declare class LocalSandbox extends MastraSandbox<string> {
    readonly id: string;
     ...
     */
    protected find(): Promise<string | undefined>;
    protected connect(_handle: string): Promise<void>;
