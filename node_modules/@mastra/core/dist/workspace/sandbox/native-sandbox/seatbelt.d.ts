 ...
 */
export declare const GENERATED_PROFILE_MARKER = "; mastra-generated-profile (regenerated on every start)";
/**
 ...
 */
export declare function isGeneratedSeatbeltProfile(profile: string): boolean;
/**
