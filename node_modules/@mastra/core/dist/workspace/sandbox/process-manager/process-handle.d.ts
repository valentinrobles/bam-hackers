...
export declare const DEFAULT_MAX_RETAINED_PROCESS_OUTPUT_BYTES: number;
/** @internal */
export declare function validateMaxRetainedProcessOutputBytes(maxRetainedBytes: number): number;
/**
 ...
 */
export declare class UnsupportedStdinCloseError extends Error {
