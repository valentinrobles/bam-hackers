 ...
 */
import type { AnySpan, SkillActionAttributes, WorkspaceActionAttributes } from '../../observability/types/tracing.js';
 ...
 * ```
 */
export declare function startWorkspaceSpan(context: ToolExecutionContext | undefined, workspace: Workspace | undefined, options: WorkspaceSpanOptions): WorkspaceSpanHandle;
/**
 ...
 */
export declare function startSkillSpan(context: ToolExecutionContext | undefined, options: SkillSpanOptions): SkillSpanHandle;
