...
//#endregion
//#region ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@standard-community/standard-json/0.3.5/1c9f0f61b390ad3f38476964121204ef02e35ff267c2b3f61b718f5f544716d2/node_modules/@standard-community/standard-json/dist/index-CLddUTqr.js
...
const getToJsonSchemaFn = async (vendor) => {
	...
	switch (vendor) {
		case "arktype":
			vendorFnPromise = (await Promise.resolve().then(() => require("./arktype-aI7TBD0R-BuTX_Phx.cjs"))).default();
			break;
		case "effect":
			vendorFnPromise = (await Promise.resolve().then(() => require("./effect-QlVUlMFu-tf02PTZR.cjs"))).default();
			break;
		case "sury":
			vendorFnPromise = (await Promise.resolve().then(() => require("./sury-CWZTCd75-YUPbTtKO.cjs"))).default();
			break;
		case "typebox":
			vendorFnPromise = (await Promise.resolve().then(() => require("./typebox-Dei93FPO-BTBshlGz.cjs"))).default();
			break;
		case "valibot":
			vendorFnPromise = (await Promise.resolve().then(() => require("./valibot--1zFm7rT-Dn5WqdyK.cjs"))).default();
			break;
		case "zod":
			vendorFnPromise = (await Promise.resolve().then(() => require("./zod-Bwrt9trS-Bi11nE9Q.cjs"))).default();
			break;
...
//# sourceMappingURL=index-CLddUTqr-DS5tJ3WV.cjs.map