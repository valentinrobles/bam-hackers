...
const require_standard_schema_adapters_ai_sdk = require("./standard-schema/adapters/ai-sdk.cjs");
const require_json_schema = require("./json-schema-CEVTdogs.cjs");
const require_standard_schema_adapters_zod_v3 = require("./standard-schema/adapters/zod-v3.cjs");
...
function convertToJsonSchema(zodSchema, options, adapterOptions) {
	require_zod_to_json.patchRecordSchemas(zodSchema);
...
function toStandardSchema(schema) {
	if (isZodV4(schema)) require_zod_to_json.patchRecordSchemas(schema);
	...
	if (isZodV3(schema)) return require_standard_schema_adapters_zod_v3.toStandardSchema(schema);
	if (isVercelSchema(schema)) return require_standard_schema_adapters_ai_sdk.toStandardSchema(schema);
	...
	return require_json_schema.toStandardSchema(schema);
}
/**
...
Object.defineProperty(exports, "JSON_SCHEMA_LIBRARY_OPTIONS", {
	enumerable: true,
	get: function() {
		return JSON_SCHEMA_LIBRARY_OPTIONS;
	}
});
...
//# sourceMappingURL=schema-Bw7nQdgA.cjs.map