...
const a2aTaskPathParams = a2aAgentIdPathParams.extend({ taskId: z.string().describe("Unique identifier for the task") });
...
const taskQueryBodySchema = z.object({ id: z.string() });
...
const taskResponseSchema = z.unknown();
