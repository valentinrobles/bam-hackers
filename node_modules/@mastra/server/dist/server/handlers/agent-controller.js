...
import { t as enforceThreadAccess } from "../../utils-KsERfbhc.js";
import { E as includeSchema, F as messageOrderBySchema, h as filterSchema } from "../../memory-BvKPIpyH.js";
...
const LIST_AGENT_CONTROLLER_THREAD_MESSAGES_ROUTE = createRoute({
	...
	description: "Returns a paginated list of messages in a specific thread. The deprecated limit parameter may only be combined with page.",
	tags: ["AgentController", "Threads"],
	requiresAuth: true,
	requiresPermission: "agent-controller:read",
	handler: async ({ mastra, controllerId, resourceId, threadId, limit, page, perPage, orderBy, include, filter, requestContext }) => {
		try {
			if (limit !== void 0 && (perPage !== void 0 || orderBy !== void 0 || include !== void 0 || filter !== void 0)) throw new HTTPException(400, { message: "limit can only be combined with page; use perPage instead" });
			const controller = getAgentControllerOrThrow(mastra, controllerId);
			const thread = await controller.queryThreadById({ threadId });
			if (!thread || resourceId && thread.resourceId && thread.resourceId !== resourceId) throw new HTTPException(404, { message: "Thread not found" });
			...
			const isLegacyLimitQuery = limit !== void 0;
			const result = await controller.queryThreadMessages(limit !== void 0 ? {
				threadId,
				resourceId,
				perPage: limit,
				page: page ?? 0,
