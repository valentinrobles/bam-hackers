...
import { A as listDatasetsQuerySchema, B as reviewSummaryResponseSchema, E as generateItemsResponseSchema, F as listExperimentsResponseSchema, G as tenancyQuerySchema, H as runExperimentItemResponseSchema, I as listItemVersionsResponseSchema, J as updateExperimentBodySchema, K as triggerExperimentBodySchema, L as listItemsQuerySchema, M as listExperimentResultsQuerySchema, N as listExperimentResultsResponseSchema, P as listExperimentsQuerySchema, R as listItemsResponseSchema, S as experimentResultResponseSchema, T as generateItemsBodySchema, V as runExperimentItemBodySchema, W as submitExperimentResultBodySchema, X as updateItemBodySchema, Y as updateExperimentResultBodySchema, _ as datasetResponseSchema, a as batchInsertItemsResponseSchema, b as experimentResponseSchema, c as compareExperimentsBodySchema, d as datasetAndExperimentIdPathParams, f as datasetAndItemIdPathParams, g as datasetItemVersionPathParams, h as datasetItemResponseSchema, i as batchInsertItemsBodySchema, j as listDatasetsResponseSchema, k as listDatasetVersionsResponseSchema, l as comparisonResponseSchema, m as datasetIdPathParams, n as batchDeleteItemsBodySchema, o as clusterFailuresBodySchema, p as datasetExperimentAndItemIdPathParams, q as updateDatasetBodySchema, r as batchDeleteItemsResponseSchema, s as clusterFailuresResponseSchema, t as addItemBodySchema, u as createDatasetBodySchema, w as experimentSummaryResponseSchema, x as experimentResultIdPathParams, y as experimentIdPathParams, z as paginationQuerySchema } from "../../datasets-CCC2huR0.js";
...
function assertExperimentDeletionAvailable() {
	if (!coreFeatures.has("experiment-deletion")) throw new HTTPException(501, { message: "Experiment deletion requires a newer @mastra/core with experiment deletion support." });
}
/**
...
const PURGE_ITEM_ROUTE = createRoute({
	method: "DELETE",
	...
	handler: async ({ mastra, datasetId, itemId, ...params }) => {
		assertDatasetsAvailable();
		if (!coreFeatures.has("dataset-item-purge")) throw new HTTPException(501, { message: "Dataset item purge requires a newer @mastra/core with dataset purge support." });
		try {
			const { organizationId, projectId } = params;
			...
			if ((await ds.getItemHistory({ itemId })).length === 0) throw new HTTPException(404, { message: `Item not found: ${itemId}` });
...
const DELETE_ANY_EXPERIMENT_ROUTE = createRoute({
	method: "DELETE",
	...
	handler: async ({ mastra, experimentId, ...params }) => {
		...
		try {
			...
			if (!(organizationId !== void 0 || projectId !== void 0)) {
				if (!await mastra.datasets.getExperiment({ experimentId })) throw new HTTPException(404, { message: `Experiment not found: ${experimentId}` });
			}
...
const TRIGGER_EXPERIMENT_ROUTE = createRoute({
	...
	handler: async ({ mastra, datasetId, ...params }) => {
		...
		try {
			...
			if (!targetType || !targetId) throw new HTTPException(400, { message: "targetType and targetId are required to start an experiment" });
...
const RUN_EXPERIMENT_ITEM_ROUTE = createRoute({
	method: "POST",
...
const SUBMIT_EXPERIMENT_RESULT_ROUTE = createRoute({
	method: "POST",
...
const FINALIZE_EXPERIMENT_ROUTE = createRoute({
	method: "POST",
...
const DELETE_EXPERIMENT_ROUTE = createRoute({
	method: "DELETE",
	path: "/datasets/:datasetId/experiments/:experimentId",
	responseType: "json",
	pathParamSchema: datasetAndExperimentIdPathParams,
...
const UPDATE_EXPERIMENT_ROUTE = createRoute({
	method: "PATCH",
	path: "/datasets/:datasetId/experiments/:experimentId",
	responseType: "json",
	pathParamSchema: datasetAndExperimentIdPathParams,
...
//#endregion
export { ADD_ITEM_ROUTE, BATCH_DELETE_ITEMS_ROUTE, BATCH_INSERT_ITEMS_ROUTE, CLUSTER_FAILURES_ROUTE, COMPARE_EXPERIMENTS_ROUTE, CREATE_DATASET_ROUTE, DELETE_ANY_EXPERIMENT_ROUTE, DELETE_DATASET_ROUTE, DELETE_EXPERIMENT_ROUTE, DELETE_ITEM_ROUTE, EXPERIMENT_REVIEW_SUMMARY_ROUTE, FINALIZE_EXPERIMENT_ROUTE, GENERATE_ITEMS_ROUTE, GET_DATASET_ROUTE, GET_EXPERIMENT_ROUTE, GET_ITEM_ROUTE, GET_ITEM_VERSION_ROUTE, LIST_ALL_EXPERIMENTS_ROUTE, LIST_DATASETS_ROUTE, LIST_DATASET_VERSIONS_ROUTE, LIST_EXPERIMENTS_ROUTE, LIST_EXPERIMENT_RESULTS_ROUTE, LIST_ITEMS_ROUTE, LIST_ITEM_VERSIONS_ROUTE, PURGE_ITEM_ROUTE, RUN_EXPERIMENT_ITEM_ROUTE, SUBMIT_EXPERIMENT_RESULT_ROUTE, TRIGGER_EXPERIMENT_ROUTE, UPDATE_DATASET_ROUTE, UPDATE_EXPERIMENT_RESULT_ROUTE, UPDATE_EXPERIMENT_ROUTE, UPDATE_ITEM_ROUTE };
