...
import { a as wrapSchemaForQueryParams } from "../../route-builder-BukcT_Kp.js";
...
function assertObservabilityTraceQuerySupported(observabilityStore) {
	...
	throw new HTTPException(501, { message: "Advanced trace queries are not supported by the configured observability store" });
}
...
//#endregion
export { NEW_ROUTE_DEFS, OBSERVABILITY_DELTA_POLLING_FEATURE, OBSERVABILITY_DELTA_POLLING_UPGRADE_MESSAGE, OBSERVABILITY_LIST_ENDPOINTS, assertObservabilityDeltaSupported, assertObservabilityTraceQuerySupported, createObservabilityListQuerySchema, getObservabilityStore, getScoresStore, getStorage };
