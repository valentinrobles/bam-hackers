...
function mapMastraToolsToResponseTools(tools) {
	...
	return Object.values(tools).flatMap((tool) => {
		...
		} else if ("inputSchema" in tool && tool.inputSchema) parameters = normalizeToolParameters(zodToJsonSchema(tool.inputSchema));
		return [{
			type: "function",
			name,
