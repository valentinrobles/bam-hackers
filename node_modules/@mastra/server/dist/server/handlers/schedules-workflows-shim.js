...
//#region src/server/handlers/schedules-workflows-shim.ts
/**
...
*/
const exportedNext = coreWorkflows.computeNextFireAt;
const exportedValidate = coreWorkflows.validateCron;
const computeNextFireAt = exportedNext ?? (() => {
	throw new Error("`computeNextFireAt` is not available in this version of @mastra/core. Schedules require @mastra/core >= 1.32.0.");
});
const validateCron = exportedValidate ?? (() => {
	throw new Error("`validateCron` is not available in this version of @mastra/core. Schedules require @mastra/core >= 1.32.0.");
});
//#endregion
export { computeNextFireAt, validateCron };
