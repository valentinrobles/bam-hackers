...
import { l as systemPackagesResponseSchema, t as apiSchemaManifestResponseSchema } from "../../system-DT2JfUun.js";
...
const GET_API_SCHEMA_ROUTE = createRoute({
	...
	requiresAuth: true,
	handler: async () => {
		const { buildApiSchemaManifest } = await import("../../api-schema-manifest-CeREx1dB.js");
