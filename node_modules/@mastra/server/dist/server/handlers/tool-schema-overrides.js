...
* is preserved.
*/
const INJECTED_OVERRIDE_DESCRIPTIONS = {
...
function stripInjectedToolOverrideFields(jsonSchema) {
	...
	for (const [key, description] of Object.entries(INJECTED_OVERRIDE_DESCRIPTIONS)) {
		...
		if (prop && typeof prop === "object" && prop.description === description) {
...
//#endregion
export { stripInjectedToolOverrideFields };

//# sourceMappingURL=tool-schema-overrides.js.map