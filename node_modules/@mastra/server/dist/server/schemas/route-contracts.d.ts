...
import type { RouteSchemas, ServerRoute, ServerRoutes } from '../server-adapter/routes/index.js';
/**
 * Extract the RouteSchemas phantom type from a route via its 4th generic parameter.
 */
type ExtractSchemas<R> = R extends ServerRoute<infer _P, infer _Res, infer _RT, infer S, infer _M, infer _Path> ? S : RouteSchemas;
/**
 ...
 * ```
 */
export type InferPathParams<R extends ServerRoute> = ExtractSchemas<R> extends RouteSchemas<infer TPath, infer _Q, infer _B, infer _R> ? TPath extends z.ZodTypeAny ? z.infer<TPath> : never : never;
/**
 ...
 * ```
 */
export type InferQueryParams<R extends ServerRoute> = ExtractSchemas<R> extends RouteSchemas<infer _P, infer TQuery, infer _B, infer _R> ? TQuery extends z.ZodTypeAny ? z.infer<TQuery> : never : never;
/**
 ...
 * ```
 */
export type InferBody<R extends ServerRoute> = ExtractSchemas<R> extends RouteSchemas<infer _P, infer _Q, infer TBody, infer _R> ? TBody extends z.ZodTypeAny ? z.infer<TBody> : never : never;
/**
 ...
 * ```
 */
export type InferResponse<R extends ServerRoute> = ExtractSchemas<R> extends RouteSchemas<infer _P, infer _Q, infer _B, infer TResp> ? TResp extends z.ZodTypeAny ? z.infer<TResp> : never : never;
/**
...
export {};
//# sourceMappingURL=route-contracts.d.ts.map