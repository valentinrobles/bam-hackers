export declare const MEMORY_ROUTES: readonly [Omit<import("@mastra/core/server").ApiRoute, "createHandler" | "handler" | "method" | "openapi" | "path"> & {
    method: "GET";
    path: "/memory/status";
    responseType: "json";
    ...
    handler(params: {
        ...
        result: boolean;
        memoryType?: "gateway" | "local" | undefined;
        observationalMemory?: {
            enabled: boolean;
