export declare const PROCESSORS_ROUTES: readonly [Omit<import("@mastra/core/server").ApiRoute, "createHandler" | "handler" | "method" | "openapi" | "path"> & {
    method: "GET";
    path: "/processors";
    responseType: "json";
    ...
    handler(params: import(".").ServerContext): Promise<Record<string, {
        ...
        phases: ("input" | "inputStep" | "outputResult" | "outputStep" | "outputStream" | "toolResult")[];
        agentIds: string[];
        configurations: {
            agentId: string;
            type: "input" | "output";
    ...
    handler(params: {
        ...
        phase: "input" | "inputStep" | "outputResult" | "outputStep" | "outputStream" | "toolResult";
        messages: {
            [x: string]: unknown;
            id: string;
            role: "assistant" | "signal" | "system" | "tool" | "user";
