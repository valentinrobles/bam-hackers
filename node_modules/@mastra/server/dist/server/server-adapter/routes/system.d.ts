 ...
 */
export declare const SYSTEM_ROUTES: readonly [Omit<import("@mastra/core/server").ApiRoute, "createHandler" | "handler" | "method" | "openapi" | "path"> & {
    method: "GET";
    ...
    handler(params: import(".").ServerContext): Promise<{
        ...
        observabilityRuntimeStrategy?: "batch-with-updates" | "event-sourced" | "insert-only" | "realtime" | undefined;
    }>;
    ...
    readonly __schemas?: import(".").RouteSchemas<undefined, undefined, undefined, import("zod").ZodObject<{
        ...
        liveKitConnectionRouteEnabled: import("zod").ZodBoolean;
    ...
    handler(params: import(".").ServerContext): Promise<{
        ...
        routes: {
            ...
            responseShape: {
                kind: "array" | "object-property" | "record" | "single" | "unknown";
