...
function schemaToJsonSchema(schema) {
	...
	return require_schema_D_ikovK6.standardSchemaToJSONSchema(require_schema_D_ikovK6.toStandardSchema(schema));
}
/**
...
function looksLikeProcessorStepSchema(schema) {
	...
	try {
		const jsonSchema = require_schema_D_ikovK6.standardSchemaToJSONSchema(require_schema_D_ikovK6.toStandardSchema(schema));
...
//# sourceMappingURL=utils-WcR0QSUB.cjs.map