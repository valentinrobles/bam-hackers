...
function getContextResourceId(requestContext) {
	return requestContext?.get(require_constants.MASTRA_RESOURCE_ID_KEY);
}
/**
...
Object.defineProperty(exports, "getContextResourceId", {
	enumerable: true,
	get: function() {
		return getContextResourceId;
	}
});
...
Object.defineProperty(exports, "mergeBodyRequestContext", {
	enumerable: true,
	get: function() {
		return mergeBodyRequestContext;
	}
});
...
//# sourceMappingURL=utils-aIu3gkhJ.cjs.map