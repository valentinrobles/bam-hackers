 ...
 */
const optimizeLodashImports = ({ include, exclude, useLodashEs, appendDotJs, parseOptions, } = {}) => {
    ...
    return {
        ...
        outputOptions(options) {
            if (useLodashEs &&
                ...
                this.error(`'useLodashEs' is true but the output format is not 'es', 'esm' or 'module', it's ${options.format ?? "undefined"}`);
            }
            return UNCHANGED;
        },
        transform(code, id) {
