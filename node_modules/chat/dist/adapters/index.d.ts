...
declare const ADAPTERS: {
    ...
    readonly gchat: {
        ...
        readonly env: {
            ...
            readonly optional: readonly [EnvVar, EnvVar, EnvVar, EnvVar, EnvVar, EnvVar, EnvVar, EnvVar, EnvVar];
        };
    ...
    readonly twilio: {
        readonly description: "Build SMS, MMS, and RCS bots with Twilio Messaging webhooks and the Messages API.";
        readonly env: {
            readonly config: readonly ["webhookUrl", "webhookVerifier", "statusCallbackUrl", "apiUrl", "contentApiUrl"];
            readonly credentialModes: readonly [{
