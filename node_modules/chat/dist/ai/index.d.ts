import { Y as ChannelVisibility, p as Message } from '../types-Cxf02p1Q.js';
import * as ai from 'ai';
import { Tool } from 'ai';
import { C as Chat } from '../messages-nw0nqFLF.js';
export { A as AiAssistantMessage, a as AiFilePart, b as AiImagePart, c as AiMessage, d as AiMessagePart, e as AiTextPart, f as AiUserMessage, T as ToAiMessagesOptions, t as toAiMessages } from '../messages-nw0nqFLF.js';
import { z } from 'zod';
...
declare const postMessage: (chat: ChatBinding, { needsApproval, guard }?: ToolOptions) => Tool<z.infer<typeof POST_MESSAGE_INPUT>, {
    messageId: string;
    threadId: string;
}>;
...
declare const postChannelMessage: (chat: ChatBinding, { needsApproval, guard }?: ToolOptions) => Tool<z.infer<typeof POST_CHANNEL_MESSAGE_INPUT>, {
    messageId: string;
    threadId: string;
}>;
...
declare const editMessage: (chat: ChatBinding, { needsApproval, guard }?: ToolOptions) => Tool<z.infer<typeof EDIT_MESSAGE_INPUT>, {
    messageId: string;
    threadId: string;
}>;
...
declare const deleteMessage: (chat: ChatBinding, { needsApproval, guard }?: ToolOptions) => Tool<z.infer<typeof DELETE_MESSAGE_INPUT>, {
    deleted: boolean;
    messageId: string;
    threadId: string;
}>;
...
declare const addReaction: (chat: ChatBinding, { needsApproval, guard }?: ToolOptions) => Tool<z.infer<typeof ADD_REACTION_INPUT>, {
    added: boolean;
    emoji: string;
    messageId: string;
    threadId: string;
...
declare const removeReaction: (chat: ChatBinding, { needsApproval, guard }?: ToolOptions) => Tool<z.infer<typeof REMOVE_REACTION_INPUT>, {
    removed: boolean;
    emoji: string;
    messageId: string;
    threadId: string;
...
declare const subscribeThread: (chat: ChatBinding, { needsApproval, guard }?: ToolOptions) => Tool<z.infer<typeof SUBSCRIBE_THREAD_INPUT>, {
    subscribed: boolean;
    threadId: string;
}>;
...
declare const unsubscribeThread: (chat: ChatBinding, { needsApproval, guard }?: ToolOptions) => Tool<z.infer<typeof UNSUBSCRIBE_THREAD_INPUT>, {
    subscribed: boolean;
    threadId: string;
}>;
...
declare const startTyping: (chat: ChatBinding, guard?: ScopeGuard) => Tool<z.infer<typeof START_TYPING_INPUT>, {
    typing: boolean;
    threadId: string;
}>;
...
declare const getUser: (chat: ChatBinding, needsApproval?: boolean) => Tool<z.infer<typeof GET_USER_INPUT>, {
    userId: string;
    userName: string;
    fullName: string;
 ...
 * ```
 */
type ApprovalConfig = boolean | Partial<Record<ChatApprovalToolName, boolean>>;
/**
