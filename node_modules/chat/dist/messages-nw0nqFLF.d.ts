import { A as Adapter, C as ChatInstance, T as TranscriptsApi, H as HistoryApi, W as WebhookOptions, a as ChatConfig, M as MentionHandler, D as DirectMessageHandler, b as MessageHandler, c as MessageUpdatedHandler, d as MessageDeletedHandler, S as SubscribedMessageHandler, R as ReactionHandler, E as EmojiValue, e as ActionHandler, O as OptionsLoadHandler, f as ModalSubmitHandler, g as ModalCloseHandler, h as SlashCommandHandler, i as AssistantThreadStartedHandler, j as AssistantContextChangedHandler, k as AgentSessionStoppedHandler, l as AgentSessionTitleChangedHandler, m as AppHomeOpenedHandler, n as AppContextChangedHandler, o as MemberJoinedChannelHandler, p as Message, q as MessageDeletedEvent, r as ReactionEvent, s as ActionEvent, t as OptionsLoadEvent, u as OptionsLoadResult, v as ModalSubmitEvent, w as ModalResponse, x as ModalCloseEvent, y as SlashCommandEvent, z as AssistantThreadStartedEvent, B as AgentSessionStoppedEvent, F as AgentSessionTitleChangedEvent, G as AssistantContextChangedEvent, I as AppHomeOpenedEvent, J as AppContextChangedEvent, K as MemberJoinedChannelEvent, L as StateAdapter, N as Logger, P as Author, Q as Thread, U as UserInfo, V as Channel, X as Attachment } from './types-Cxf02p1Q.js';
...
declare class Chat<TAdapters extends Record<string, Adapter> = Record<string, Adapter>, TState = Record<string, unknown>> implements ChatInstance {
    ...
    private readonly agentSessionStoppedHandlers;
    private readonly agentSessionTitleChangedHandlers;
    ...
    private readonly activeTurnControllers;
    ...
    private activeTurnKey;
    private abortTurnKey;
    private monitorTurnAbort;
    private clearTurnMarkers;
    private dispatchToHandlersWithSignal;
