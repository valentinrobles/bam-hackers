...
import type { Metrics, Span, SpanContextManager, StartSpanOptions } from '@posthog/core';
...
export declare abstract class PostHogBackendClient extends PostHogCoreStateless implements IPostHog {
    ...
    flush(): Promise<void>;
    private _flushKeepingRuntimeAlive;
     ...
     */
    private get _spanContextManager();
    /**
     ...
     */
    protected getEvaluationRuntime(): 'server';
    /**
